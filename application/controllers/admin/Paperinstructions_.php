	...
	public function add()
	{
		if($this->session->userdata('role_id')==2)
		{
			if($this->input->post('submit'))
			{
				...
				$this->form_validation->set_rules('pi_paper_instruction_en', 'Paper Instructions (Eng)', 'trim|required');
				$this->form_validation->set_rules('pi_paper_instruction_ur', 'Paper Instructions (Urdu)', 'trim|required');

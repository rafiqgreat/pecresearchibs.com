	...
	<section class="content" >
		...
		<div class="card card-default color-palette-bo">
			...
			<div class="card-body">
				...
				$pilotheaders = $this->Pilotbank_model->get_pilotheader_by_suject($paper_erqs[0]->subject_name_en);
				...
				<?php }?>
                                   ...
                                   <?php
									...
									if($paper_erq->item_type == 'ERQ'){
										...
										<tr><td colspan="2" style="font-weight:bold; font-size:20px" >
                                          ...
                                          <a href=<?php echo base_url('admin/pilotbank/pilot_view_combine/'.$paper_erq->item_id); ?> target="_blank">Question No.<?php print $i;?> </a>
										...
										<span style="padding-left:50px; font-size:20px"><?php echo html_entity_decode($paper_erq->item_stem_en);?></span>
										...
										<tr><td colspan="2" style="text-align:right; font-weight:bold; font-size: 25px;" class="urdufont-right">  

                                        <?php if($this->session->userdata('role_id')==2 || $this->session->userdata('role_id')==4 || $this->session->userdata('role_id')==1){?>

										  <?php if ($paper_erq->item_type=='MCQ'){?>

                                          <a href=<?php echo base_url('admin/pilotbank/pilot_view_combine/'.$paper_erq->item_id); ?> target="_blank">سوال نمبر <?php print $i;?>:&nbsp;<?php print $i;?> </a>

                                          <?php }?>

                                          <?php if ($paper_erq->item_type=='ERQ'){?>

                                          <a href=<?php echo base_url('admin/pilotbank/pilot_view_combine/'.$paper_erq->item_id); ?> target="_blank">سوال نمبر <?php print $i;?>:&nbsp; </a>

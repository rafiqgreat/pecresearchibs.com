  ...
  <div class="row">
    ...
    <div class="col-4" >
      <div class="col-12" style="alignment-adjust:central">
        <table border="1px" bordercolor="#000000" width="100%" style="float:right; font-weight:bold; font-size:14px; line-height:35px" cellpadding="7px">
          <tr>
...
?>               
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <a href=<?php echo base_url('admin/pilotbank/pilot_edit_combine/'.$item->item_id); ?>><input type="button" name="edit" id="edit" value="Edit Item" class="btn btn-info pull-right" style="margin-top:10px; margin-left:10px;"></a><?php } ?>
        </div>
    </div>
</div>
                ...
                <div id="area-chart" style="height: 350px;" class="full-width-chart">
                  <table border="1" cellspacing="0" cellpadding="0" class="table table-hover">
                    ...
                    <tr>
                      ...
                      <th width="59" valign="top" style="padding:5px; text-align:center;"><p>0-20%</p></th>
                      <th width="59" valign="top" style="padding:5px; text-align:center;"><p>20-40%</p></th>
                      <th width="59" valign="top" style="padding:5px; text-align:center;"><p>40-60%</p></th>
                      <th width="59" valign="top" style="padding:5px; text-align:center;"><p>60-80%</p></th>
                      <th width="64" valign="top" style="padding:5px; text-align:center;"><p>80-100%</p></th>
                    ...
                    <tr>
                      ...
                      <td width="64" valign="top" style="padding:5px; text-align:center;"><p><?php echo $item->item_1g_5p; ?></p></td>
                    ...
                    <tr>
                      ...
                      <td width="64" valign="top" style="padding:5px; text-align:center;"><p><?php echo $item->item_2g_5p; ?></p></td>
                    ...
                    <tr>
                      ...
                      <td width="64" valign="top" style="padding:5px; text-align:center;"><p><?php echo $item->item_3g_5p; ?></p></td>
                    ...
                    <tr>
                      ...
                      <td width="64" valign="top" style="padding:5px; text-align:center;"><p><?php echo $item->item_4g_5p; ?></p></td>
                      <td width="59" valign="top" style="padding:5px; text-align:center;"><p>Olive</p></td>
                      <td width="59" valign="top" style="padding:5px; text-align:center;"><p>**KEY**</p></td>
                    </tr>
                  </table>
                </div>
              </div>
...
<script>
   ...
   var line_data1 = {
	...
	<?php if($item->item_1g_1p!=0 || $item->item_1g_2p!=0 ||  $item->item_1g_3p!=0 || $item->item_1g_4p!=0 ||  $item->item_1g_5p!=0 ||  
			$item->item_2g_1p!=0 ||  $item->item_2g_2p!=0 ||  $item->item_2g_3p!=0 ||  $item->item_2g_4p!=0 ||  $item->item_2g_5p!=0 ||  
			$item->item_3g_1p!=0 || $item->item_3g_2p!=0 || $item->item_3g_3p!=0 || $item->item_3g_4p!=0 || $item->item_3g_5p!=0 ||
			$item->item_4g_1p!=0 || $item->item_4g_2p!=0 || $item->item_4g_3p!=0 || $item->item_4g_4p!=0 || $item->item_4g_5p!=0 ){?>

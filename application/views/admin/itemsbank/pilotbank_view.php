...
?>
            ...
            <div class="row col-12" >
                ...
                <div class="col-lg-12 col-sm-12">                         
                  ...
                  <div style="font-weight:bold"><a href=<?php echo base_url('admin/pilot_itemspara/edit_para_text/'.$paper_para->para_id); ?> target="_blank" style="color:#09F"><?php echo $paper_para->para_title_en; ?></a></div>
                </div>
                <?php }?>
				...
				<div class="col-lg-12 col-sm-12 urdufont-right" style="text-align:right" >                         
                    ...
                    <a href=<?php echo base_url('admin/pilot_itemspara/edit_para_text/'.$paper_para->para_id); ?> target="_blank" style="color:#09F"><?php echo $paper_para->para_title_ur; ?></a>
                </div>
                <?php }?>
             </div>
			 <div class="row" >		
<table style="width:100%">					
			...
			if($paper_para->para_text_en!='') 
			{
				...
				<tr>
                        ...
                        <?php echo html_entity_decode($paper_para->para_text_en);?></td>
             ...
             <?php 
				...
				if($paper_para->para_text_ur!='') {?>
                    ...
                    <tr>
						...
						<?php echo html_entity_decode($paper_para->para_text_ur);?></td>
						...
						?>
						  <tr>
							<td colspan="2" style="font-weight:bold">
							  ...
							  <?php if($para_item_21->item_stem_en!=""){?><a href="<?php base_url('admin/pilot_items/pilot_view_combine/'.$para_item_21->item_id); ?>" target="_blank">Question No. <?php print ++$ctr;?> :</a><?php }?>
							  <?php }?>
						  ...
						  <tr>
							<?php if($para_item_21->item_stem_ur!=""){?>
                                <td colspan="2" style="text-align:right; font-weight:bold" class="urdufont-right">
                                    <?php if($this->session->userdata('role_id')==2 || $this->session->userdata('role_id')==4 || $this->session->userdata('role_id')== 1){?>
                                    <a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_21->item_id); ?> target="_blank">سوال نمبر <?php print ++$ctr;?></a>
                                    <?php }?>
									 : <?php echo html_entity_decode($para_item_21->item_stem_ur);?>
                                </td>
							<?php }?>
						  </tr>
					...
					if(isset($paper_para->para_item_22)&&$paper_para->para_item_22!=0)
					{
						...
						?>
						  ...
						  <tr>
							<?php if($para_item_22->item_stem_ur!=""){?>
                            <td colspan="2" style="text-align:right; font-weight:bold" class="urdufont-right">
                            <?php if($this->session->userdata('role_id')==2 || $this->session->userdata('role_id')==4 || $this->session->userdata('role_id')== 1){?>
                            <a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_22->item_id); ?> target="_blank">سوال نمبر <?php print ++$ctr;?></a>
                            <?php }?>
                            : <?php echo html_entity_decode($para_item_22->item_stem_ur);?></td><?php }?>
						  </tr>
					...
					if(isset($paper_para->para_item_23)&&$paper_para->para_item_23!=0)
					{
						...
						?>
						  ...
						  <tr>
							<?php if($para_item_23->item_stem_ur!=""){?><td colspan="2" style="text-align:right; font-weight:bold" class="urdufont-right"> 
							<?php if($this->session->userdata('role_id')==2 || $this->session->userdata('role_id')==4 || $this->session->userdata('role_id')== 1){?>
                            <a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_23->item_id); ?> target="_blank">سوال نمبر <?php print ++$ctr;?></a>
                            <?php }?> : <?php echo html_entity_decode($para_item_23->item_stem_ur);?></td><?php }?>
						  </tr>
					...
					if(isset($paper_para->para_item_24)&&$paper_para->para_item_24!=0)
					{
						...
						?>
						  ...
						  <tr>
							<?php if($para_item_24->item_stem_ur!=""){?><td colspan="2" style="text-align:right; font-weight:bold" class="urdufont-right"> <?php if($this->session->userdata('role_id')==2 || $this->session->userdata('role_id')==4 || $this->session->userdata('role_id')== 1){?>
                            <a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_24->item_id); ?> target="_blank">سوال نمبر <?php print ++$ctr;?></a>
                            <?php }?> : <?php echo html_entity_decode($para_item_24->item_stem_ur);?></td><?php }?>
						  </tr>
					...
					if(isset($paper_para->para_item_25)&&$paper_para->para_item_25!=0)
					{
						...
						?>
						  ...
						  <tr>
							<?php if($para_item_25->item_stem_ur!=""){?><td colspan="2" style="text-align:right; font-weight:bold" class="urdufont-right"> <?php if($this->session->userdata('role_id')==2 || $this->session->userdata('role_id')==4 || $this->session->userdata('role_id')== 1){?>
                            <a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_25->item_id); ?> target="_blank">سوال نمبر <?php print ++$ctr;?></a>
                            <?php }?> : <?php echo html_entity_decode($para_item_25->item_stem_ur);?></td><?php }?>
						  </tr>
					...
					if(isset($paper_para->para_item_26)&&$paper_para->para_item_26!=0)
					{
						...
						?>
						  ...
						  <tr>
							<?php if($para_item_26->item_stem_ur!=""){?><td colspan="2" style="text-align:right; font-weight:bold" class="urdufont-right"> <?php if($this->session->userdata('role_id')==2 || $this->session->userdata('role_id')==4 || $this->session->userdata('role_id')== 1){?>
                            <a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_26->item_id); ?> target="_blank">سوال نمبر <?php print ++$ctr;?></a>
                            <?php }?> : <?php echo html_entity_decode($para_item_26->item_stem_ur);?></td><?php }?>
						  </tr>
					...
					if(isset($paper_para->para_item_27)&&$paper_para->para_item_27!=0)
					{
						...
						?>
						  ...
						  <tr>
							<?php if($para_item_27->item_stem_ur!=""){?><td colspan="2" style="text-align:right; font-weight:bold" class="urdufont-right"> <?php if($this->session->userdata('role_id')==2 || $this->session->userdata('role_id')==4 || $this->session->userdata('role_id')== 1){?>
                            <a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_27->item_id); ?> target="_blank">سوال نمبر <?php print ++$ctr;?></a>
                            <?php }?> : <?php echo html_entity_decode($para_item_27->item_stem_ur);?></td><?php }?>
						  </tr>
					...
					if(isset($paper_para->para_item_28)&&$paper_para->para_item_28!=0)
					{
						...
						?>
						  ...
						  <tr>
							<?php if($para_item_28->item_stem_ur!=""){?><td colspan="2" style="text-align:right; font-weight:bold" class="urdufont-right"> <?php if($this->session->userdata('role_id')==2 || $this->session->userdata('role_id')==4 || $this->session->userdata('role_id')== 1){?>
                            <a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_28->item_id); ?> target="_blank">سوال نمبر <?php print ++$ctr;?></a>
                            <?php }?> : <?php echo html_entity_decode($para_item_28->item_stem_ur);?></td><?php }?>						  </tr>
					...
					if(isset($paper_para->para_item_29)&&$paper_para->para_item_29!=0)
					{
						...
						?>
						  ...
						  <tr>
							<?php if($para_item_29->item_stem_ur!=""){?><td colspan="2" style="text-align:right; font-weight:bold" class="urdufont-right"> <?php if($this->session->userdata('role_id')==2 || $this->session->userdata('role_id')==4 || $this->session->userdata('role_id')== 1){?>
                            <a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_29->item_id); ?> target="_blank">سوال نمبر <?php print ++$ctr;?></a>
                            <?php }?> : <?php echo html_entity_decode($para_item_29->item_stem_ur);?></td><?php }?>
						  </tr>
					...
					if(isset($paper_para->para_item_30)&&$paper_para->para_item_30!=0)
					{
						...
						?>
						  ...
						  <tr>
							<?php if($para_item_30->item_stem_ur!=""){?><td colspan="2" style="text-align:right; font-weight:bold" class="urdufont-right"> <?php if($this->session->userdata('role_id')==2 || $this->session->userdata('role_id')==4 || $this->session->userdata('role_id')== 1){?>
                            <a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_30->item_id); ?> target="_blank">سوال نمبر <?php print ++$ctr;?></a>
                            <?php }?> : <?php echo html_entity_decode($para_item_30->item_stem_ur);?></td><?php }?>
						  </tr>

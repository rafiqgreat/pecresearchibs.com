             ...
             <div class="col-md-7">
                 <div class="row">
                     <div class="col-md-4 col-sm-12">
                        ...
                        <select name="v1_item_id_<?=$i?>" class="form-control form-group item" id="v1_item_id_<?=$i?>"  >
                          <option value="">--Select Item/Question--</option>
                        </select>
                     </div>
                     <div class="col-md-4 col-sm-12">
                     	<label for="pb_subject_id" class="control-label">Question 2.<?=$i?> *</label>
                        <select name="v2_item_id_<?=$i?>" class="form-control form-group item" id="v2_item_id_<?=$i?>"  >
                          <option value="">--Select Item/Question--</option>
                        </select>
                     </div>
                     <div class="col-md-4 col-sm-12">
                     	<label for="v3_item_id_<?=$i?>" class="control-label">Question 3.<?=$i?> *</label>
                        <select name="v3_item_id_<?=$i?>" class="form-control form-group item" id="v3_item_id_<?=$i?>"  >
                          <option value="">--Select Item/Question--</option>
                        </select>
                     </div>
                 </div>
             ...
             <div class="col-md-5">
                    <div class="row">
                            <div class="col-md-6 col-sm-12">
                                ...
                                <select name="v4_item_id_<?=$i?>" class="form-control form-group item" id="v4_item_id_<?=$i?>"  >
                                  <option value="">--Select Item/Question--</option>
                                </select>
                            </div>
                            <div class="col-md-6 col-sm-12">
                            	<label for="v5_item_id_<?=$i?>" class="control-label">Question 5.<?=$i?> *</label>
                                <select name="v5_item_id_<?=$i?>" class="form-control form-group item" id="v5_item_id_<?=$i?>"  >
                                  <option value="">--Select Item/Question--</option>
                                </select>
                            </div>
                        </div>
...
//$(".item")[0].selectedIndex = 0;
      ...
      $('.item')
         .append($("<option></option>")
                    ...
                    .text('SLO-'+value.slo_number+ ' '+value.item_code+'-('+value.item_id+')')
                  ); 
       });

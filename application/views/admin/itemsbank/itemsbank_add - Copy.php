...
<!---------------------------------------------Start Block-1------------------------------------------------------------>             
				...
				<div class="col-lg-11 col-sm-12">                         
                    <div class="row">
                        <div class="col-lg-2 col-sm-12">                         
                            ...
                            <option value="">--Select Content Stand--</option>
                            </select>
                        </div>				
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b1_scs_id_1" class="form-control form-group" id="ib_b1_scs_id_1"  required>
                            <option value="">--Select SubContent Stand--</option>
                            </select>
                        </div>	
            ...
            <div class="row">
				...
				<div class="col-lg-11 col-sm-12">                         
                    <div class="row">
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b1_cs_id_4" class="form-control form-group" id="ib_b1_cs_id_4"  >
                            <option value="">--Select Content Stand--</option>
                            </select>
                        </div>				
                        <div class="col-lg-2 col-sm-12">                         
...
<!---------------------------------------------Start Block-16------------------------------------------------------------>             
            ...
            <div class="row">
				...
				<div class="col-lg-11 col-sm-12">                         
                    <div class="row">
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b16_cs_id_1" class="form-control form-group" id="ib_b16_cs_id_1"  >
                            <option value="">--Select Content Stand--</option>
                            </select>
                        </div>				
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b16_scs_id_1" class="form-control form-group" id="ib_b16_cs_id_1" >
                            <option value="">--Select SubContent Stand--</option>
                            </select>
                        </div>	
                        <div class="col-lg-3 col-sm-12">                         
                            <select name="ib_b16_slo_id_1" class="form-control form-group" id="ib_b16_slo_id_1"  >
                            <option value="">--Select SLO Statement--</option>
                            </select>
                        </div>				
                        <div class="col-lg-5 col-sm-12">                         
            ...
            <div class="row">
				...
				<div class="col-lg-11 col-sm-12">                         
                    <div class="row">
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b16_cs_id_2" class="form-control form-group" id="ib_b16_cs_id_2"  >
                            <option value="">--Select Content Stand--</option>
                            </select>
                        </div>				
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b16_scs_id_2" class="form-control form-group" id="ib_b16_scs_id_2"  >
                            <option value="">--Select SubContent Stand--</option>
                            </select>
                        </div>	
                        <div class="col-lg-3 col-sm-12">                         
                            <select name="ib_b16_slo_id_2" class="form-control form-group" id="ib_b16_slo_id_2"  >
                            <option value="">--Select SLO Statement--</option>
                            </select>
                        </div>				
                        <div class="col-lg-5 col-sm-12">                         
            ...
            <div class="row">
				...
				<div class="col-lg-11 col-sm-12">                         
                    <div class="row">
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b16_cs_id_3" class="form-control form-group" id="ib_b16_cs_id_3"  >
                            <option value="">--Select Content Stand--</option>
                            </select>
                        </div>				
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b16_scs_id_3" class="form-control form-group" id="ib_b16_scs_id_3"  >
                            <option value="">--Select SubContent Stand--</option>
                            </select>
                        </div>	
                        <div class="col-lg-3 col-sm-12">                         
                            <select name="ib_b16_slo_id_3" class="form-control form-group" id="ib_b16_slo_id_3"  >
                            <option value="">--Select SLO Statement--</option>
                            </select>
                        </div>				
                        <div class="col-lg-5 col-sm-12">                         
            ...
            <div class="row">
				...
				<div class="col-lg-11 col-sm-12">                         
                    <div class="row">
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b16_cs_id_4" class="form-control form-group" id="ib_b16_cs_id_4"  >
                            <option value="">--Select Content Stand--</option>
                            </select>
                        </div>				
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b16_scs_id_4" class="form-control form-group" id="ib_b16_scs_id_4"  >
                            <option value="">--Select SubContent Stand--</option>
                            </select>
                        </div>	
                        <div class="col-lg-3 col-sm-12">                         
                            <select name="ib_b16_slo_id_4" class="form-control form-group" id="ib_b16_slo_id_4"  >
                            <option value="">--Select SLO Statement--</option>
                            </select>
                        </div>				
                        <div class="col-lg-5 col-sm-12">                         
...
<!---------------------------------------------Start Block-17------------------------------------------------------------>             
            ...
            <div class="row">
				...
				<div class="col-lg-11 col-sm-12">                         
                    <div class="row">
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b17_cs_id_1" class="form-control form-group" id="ib_b17_cs_id_1"  >
                            <option value="">--Select Content Stand--</option>
                            </select>
                        </div>				
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b17_scs_id_1" class="form-control form-group" id="ib_b17_cs_id_1" >
                            <option value="">--Select SubContent Stand--</option>
                            </select>
                        </div>	
                        <div class="col-lg-3 col-sm-12">                         
                            <select name="ib_b17_slo_id_1" class="form-control form-group" id="ib_b17_slo_id_1"  >
                            <option value="">--Select SLO Statement--</option>
                            </select>
                        </div>				
                        <div class="col-lg-5 col-sm-12">                         
            ...
            <div class="row">
				...
				<div class="col-lg-11 col-sm-12">                         
                    <div class="row">
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b17_cs_id_2" class="form-control form-group" id="ib_b17_cs_id_2"  >
                            <option value="">--Select Content Stand--</option>
                            </select>
                        </div>				
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b17_scs_id_2" class="form-control form-group" id="ib_b17_scs_id_2"  >
                            <option value="">--Select SubContent Stand--</option>
                            </select>
                        </div>	
                        <div class="col-lg-3 col-sm-12">                         
                            <select name="ib_b17_slo_id_2" class="form-control form-group" id="ib_b17_slo_id_2"  >
                            <option value="">--Select SLO Statement--</option>
                            </select>
                        </div>				
                        <div class="col-lg-5 col-sm-12">                         
            ...
            <div class="row">
				...
				<div class="col-lg-11 col-sm-12">                         
                    <div class="row">
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b17_cs_id_3" class="form-control form-group" id="ib_b17_cs_id_3"  >
                            <option value="">--Select Content Stand--</option>
                            </select>
                        </div>				
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b17_scs_id_3" class="form-control form-group" id="ib_b17_scs_id_3"  >
                            <option value="">--Select SubContent Stand--</option>
                            </select>
                        </div>	
                        <div class="col-lg-3 col-sm-12">                         
                            <select name="ib_b17_slo_id_3" class="form-control form-group" id="ib_b17_slo_id_3"  >
                            <option value="">--Select SLO Statement--</option>
                            </select>
                        </div>				
                        <div class="col-lg-5 col-sm-12">                         
            ...
            <div class="row">
				...
				<div class="col-lg-11 col-sm-12">                         
                    <div class="row">
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b17_cs_id_4" class="form-control form-group" id="ib_b17_cs_id_4"  >
                            <option value="">--Select Content Stand--</option>
                            </select>
                        </div>				
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b17_scs_id_4" class="form-control form-group" id="ib_b17_scs_id_4"  >
                            <option value="">--Select SubContent Stand--</option>
                            </select>
                        </div>	
                        <div class="col-lg-3 col-sm-12">                         
                            <select name="ib_b17_slo_id_4" class="form-control form-group" id="ib_b17_slo_id_4"  >
                            <option value="">--Select SLO Statement--</option>
                            </select>
                        </div>				
                        <div class="col-lg-5 col-sm-12">                         
...
<!---------------------------------------------Start Block-18------------------------------------------------------------>             
            ...
            <div class="row">
				...
				<div class="col-lg-11 col-sm-12">                         
                    <div class="row">
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b18_cs_id_1" class="form-control form-group" id="ib_b18_cs_id_1"  >
                            <option value="">--Select Content Stand--</option>
                            </select>
                        </div>				
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b18_scs_id_1" class="form-control form-group" id="ib_b18_cs_id_1" >
                            <option value="">--Select SubContent Stand--</option>
                            </select>
                        </div>	
                        <div class="col-lg-3 col-sm-12">                         
                            <select name="ib_b18_slo_id_1" class="form-control form-group" id="ib_b18_slo_id_1"  >
                            <option value="">--Select SLO Statement--</option>
                            </select>
                        </div>				
                        <div class="col-lg-5 col-sm-12">                         
            ...
            <div class="row">
				...
				<div class="col-lg-11 col-sm-12">                         
                    <div class="row">
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b18_cs_id_2" class="form-control form-group" id="ib_b18_cs_id_2"  >
                            <option value="">--Select Content Stand--</option>
                            </select>
                        </div>				
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b18_scs_id_2" class="form-control form-group" id="ib_b18_scs_id_2"  >
                            <option value="">--Select SubContent Stand--</option>
                            </select>
                        </div>	
                        <div class="col-lg-3 col-sm-12">                         
                            <select name="ib_b18_slo_id_2" class="form-control form-group" id="ib_b18_slo_id_2"  >
                            <option value="">--Select SLO Statement--</option>
                            </select>
                        </div>				
                        <div class="col-lg-5 col-sm-12">                         
            ...
            <div class="row">
				...
				<div class="col-lg-11 col-sm-12">                         
                    <div class="row">
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b18_cs_id_3" class="form-control form-group" id="ib_b18_cs_id_3"  >
                            <option value="">--Select Content Stand--</option>
                            </select>
                        </div>				
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b18_scs_id_3" class="form-control form-group" id="ib_b18_scs_id_3"  >
                            <option value="">--Select SubContent Stand--</option>
                            </select>
                        </div>	
                        <div class="col-lg-3 col-sm-12">                         
                            <select name="ib_b18_slo_id_3" class="form-control form-group" id="ib_b18_slo_id_3"  >
                            <option value="">--Select SLO Statement--</option>
                            </select>
                        </div>				
                        <div class="col-lg-5 col-sm-12">                         
            ...
            <div class="row">
				...
				<div class="col-lg-11 col-sm-12">                         
                    <div class="row">
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b18_cs_id_4" class="form-control form-group" id="ib_b18_cs_id_4"  >
                            <option value="">--Select Content Stand--</option>
                            </select>
                        </div>				
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b18_scs_id_4" class="form-control form-group" id="ib_b18_scs_id_4"  >
                            <option value="">--Select SubContent Stand--</option>
                            </select>
                        </div>	
                        <div class="col-lg-3 col-sm-12">                         
                            <select name="ib_b18_slo_id_4" class="form-control form-group" id="ib_b18_slo_id_4"  >
                            <option value="">--Select SLO Statement--</option>
                            </select>
                        </div>				
                        <div class="col-lg-5 col-sm-12">                         
...
<!---------------------------------------------Start Block-19------------------------------------------------------------>             
            ...
            <div class="row">
				...
				<div class="col-lg-11 col-sm-12">                         
                    <div class="row">
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b19_cs_id_1" class="form-control form-group" id="ib_b19_cs_id_1"  >
                            <option value="">--Select Content Stand--</option>
                            </select>
                        </div>				
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b19_scs_id_1" class="form-control form-group" id="ib_b19_cs_id_1" >
                            <option value="">--Select SubContent Stand--</option>
                            </select>
                        </div>	
                        <div class="col-lg-3 col-sm-12">                         
                            <select name="ib_b19_slo_id_1" class="form-control form-group" id="ib_b19_slo_id_1"  >
                            <option value="">--Select SLO Statement--</option>
                            </select>
                        </div>				
                        <div class="col-lg-5 col-sm-12">                         
            ...
            <div class="row">
				...
				<div class="col-lg-11 col-sm-12">                         
                    <div class="row">
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b19_cs_id_2" class="form-control form-group" id="ib_b19_cs_id_2"  >
                            <option value="">--Select Content Stand--</option>
                            </select>
                        </div>				
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b19_scs_id_2" class="form-control form-group" id="ib_b19_scs_id_2"  >
                            <option value="">--Select SubContent Stand--</option>
                            </select>
                        </div>	
                        <div class="col-lg-3 col-sm-12">                         
                            <select name="ib_b19_slo_id_2" class="form-control form-group" id="ib_b19_slo_id_2"  >
                            <option value="">--Select SLO Statement--</option>
                            </select>
                        </div>				
                        <div class="col-lg-5 col-sm-12">                         
            ...
            <div class="row">
				...
				<div class="col-lg-11 col-sm-12">                         
                    <div class="row">
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b19_cs_id_3" class="form-control form-group" id="ib_b19_cs_id_3"  >
                            <option value="">--Select Content Stand--</option>
                            </select>
                        </div>				
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b19_scs_id_3" class="form-control form-group" id="ib_b19_scs_id_3"  >
                            <option value="">--Select SubContent Stand--</option>
                            </select>
                        </div>	
                        <div class="col-lg-3 col-sm-12">                         
                            <select name="ib_b19_slo_id_3" class="form-control form-group" id="ib_b19_slo_id_3"  >
                            <option value="">--Select SLO Statement--</option>
                            </select>
                        </div>				
                        <div class="col-lg-5 col-sm-12">                         
            ...
            <div class="row">
				...
				<div class="col-lg-11 col-sm-12">                         
                    <div class="row">
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b19_cs_id_4" class="form-control form-group" id="ib_b19_cs_id_4"  >
                            <option value="">--Select Content Stand--</option>
                            </select>
                        </div>				
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b19_scs_id_4" class="form-control form-group" id="ib_b19_scs_id_4"  >
                            <option value="">--Select SubContent Stand--</option>
                            </select>
                        </div>	
                        <div class="col-lg-3 col-sm-12">                         
                            <select name="ib_b19_slo_id_4" class="form-control form-group" id="ib_b19_slo_id_4"  >
                            <option value="">--Select SLO Statement--</option>
                            </select>
                        </div>				
                        <div class="col-lg-5 col-sm-12">                         
...
<!---------------------------------------------Start Block-20------------------------------------------------------------>             
            ...
            <div class="row">
				...
				<div class="col-lg-11 col-sm-12">                         
                    <div class="row">
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b20_cs_id_1" class="form-control form-group" id="ib_b20_cs_id_1"  >
                            <option value="">--Select Content Stand--</option>
                            </select>
                        </div>				
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b20_scs_id_1" class="form-control form-group" id="ib_b20_cs_id_1" >
                            <option value="">--Select SubContent Stand--</option>
                            </select>
                        </div>	
                        <div class="col-lg-3 col-sm-12">                         
                            <select name="ib_b20_slo_id_1" class="form-control form-group" id="ib_b20_slo_id_1"  >
                            <option value="">--Select SLO Statement--</option>
                            </select>
                        </div>				
                        <div class="col-lg-5 col-sm-12">                         
            ...
            <div class="row">
				...
				<div class="col-lg-11 col-sm-12">                         
                    <div class="row">
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b20_cs_id_2" class="form-control form-group" id="ib_b20_cs_id_2"  >
                            <option value="">--Select Content Stand--</option>
                            </select>
                        </div>				
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b20_scs_id_2" class="form-control form-group" id="ib_b20_scs_id_2"  >
                            <option value="">--Select SubContent Stand--</option>
                            </select>
                        </div>	
                        <div class="col-lg-3 col-sm-12">                         
                            <select name="ib_b20_slo_id_2" class="form-control form-group" id="ib_b20_slo_id_2"  >
                            <option value="">--Select SLO Statement--</option>
                            </select>
                        </div>				
                        <div class="col-lg-5 col-sm-12">                         
            ...
            <div class="row">
				...
				<div class="col-lg-11 col-sm-12">                         
                    <div class="row">
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b20_cs_id_3" class="form-control form-group" id="ib_b20_cs_id_3"  >
                            <option value="">--Select Content Stand--</option>
                            </select>
                        </div>				
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b20_scs_id_3" class="form-control form-group" id="ib_b20_scs_id_3"  >
                            <option value="">--Select SubContent Stand--</option>
                            </select>
                        </div>	
                        <div class="col-lg-3 col-sm-12">                         
                            <select name="ib_b20_slo_id_3" class="form-control form-group" id="ib_b20_slo_id_3"  >
                            <option value="">--Select SLO Statement--</option>
                            </select>
                        </div>				
                        <div class="col-lg-5 col-sm-12">                         
            ...
            <div class="row">
				...
				<div class="col-lg-11 col-sm-12">                         
                    <div class="row">
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b20_cs_id_4" class="form-control form-group" id="ib_b20_cs_id_4"  >
                            <option value="">--Select Content Stand--</option>
                            </select>
                        </div>				
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b20_scs_id_4" class="form-control form-group" id="ib_b20_scs_id_4"  >
                            <option value="">--Select SubContent Stand--</option>
                            </select>
                        </div>	
                        <div class="col-lg-3 col-sm-12">                         
                            <select name="ib_b20_slo_id_4" class="form-control form-group" id="ib_b20_slo_id_4"  >
                            <option value="">--Select SLO Statement--</option>
                            </select>
                        </div>				
                        <div class="col-lg-5 col-sm-12">                         
...
<!---------------------------------------------Start Block-21------------------------------------------------------------>             
            ...
            <div class="row">
				...
				<div class="col-lg-11 col-sm-12">                         
                    <div class="row">
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b21_cs_id_1" class="form-control form-group" id="ib_b21_cs_id_1"  >
                            <option value="">--Select Content Stand--</option>
                            </select>
                        </div>				
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b21_scs_id_1" class="form-control form-group" id="ib_b21_cs_id_1" >
                            <option value="">--Select SubContent Stand--</option>
                            </select>
                        </div>	
                        <div class="col-lg-3 col-sm-12">                         
                            <select name="ib_b21_slo_id_1" class="form-control form-group" id="ib_b21_slo_id_1"  >
                            <option value="">--Select SLO Statement--</option>
                            </select>
                        </div>				
                        <div class="col-lg-5 col-sm-12">                         
            ...
            <div class="row">
				...
				<div class="col-lg-11 col-sm-12">                         
                    <div class="row">
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b21_cs_id_2" class="form-control form-group" id="ib_b21_cs_id_2"  >
                            <option value="">--Select Content Stand--</option>
                            </select>
                        </div>				
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b21_scs_id_2" class="form-control form-group" id="ib_b21_scs_id_2"  >
                            <option value="">--Select SubContent Stand--</option>
                            </select>
                        </div>	
                        <div class="col-lg-3 col-sm-12">                         
                            <select name="ib_b21_slo_id_2" class="form-control form-group" id="ib_b21_slo_id_2"  >
                            <option value="">--Select SLO Statement--</option>
                            </select>
                        </div>				
                        <div class="col-lg-5 col-sm-12">                         
            ...
            <div class="row">
				...
				<div class="col-lg-11 col-sm-12">                         
                    <div class="row">
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b21_cs_id_3" class="form-control form-group" id="ib_b21_cs_id_3"  >
                            <option value="">--Select Content Stand--</option>
                            </select>
                        </div>				
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b21_scs_id_3" class="form-control form-group" id="ib_b21_scs_id_3"  >
                            <option value="">--Select SubContent Stand--</option>
                            </select>
                        </div>	
                        <div class="col-lg-3 col-sm-12">                         
                            <select name="ib_b21_slo_id_3" class="form-control form-group" id="ib_b21_slo_id_3"  >
                            <option value="">--Select SLO Statement--</option>
                            </select>
                        </div>				
                        <div class="col-lg-5 col-sm-12">                         
            ...
            <div class="row">
				...
				<div class="col-lg-11 col-sm-12">                         
                    <div class="row">
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b21_cs_id_4" class="form-control form-group" id="ib_b21_cs_id_4"  >
                            <option value="">--Select Content Stand--</option>
                            </select>
                        </div>				
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b21_scs_id_4" class="form-control form-group" id="ib_b21_scs_id_4"  >
                            <option value="">--Select SubContent Stand--</option>
                            </select>
                        </div>	
                        <div class="col-lg-3 col-sm-12">                         
                            <select name="ib_b21_slo_id_4" class="form-control form-group" id="ib_b21_slo_id_4"  >
                            <option value="">--Select SLO Statement--</option>
                            </select>
                        </div>				
                        <div class="col-lg-5 col-sm-12">                         
...
<!---------------------------------------------Start Block-22------------------------------------------------------------>             
            ...
            <div class="row">
				...
				<div class="col-lg-11 col-sm-12">                         
                    <div class="row">
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b22_cs_id_1" class="form-control form-group" id="ib_b22_cs_id_1"  >
                            <option value="">--Select Content Stand--</option>
                            </select>
                        </div>				
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b22_scs_id_1" class="form-control form-group" id="ib_b22_cs_id_1" >
                            <option value="">--Select SubContent Stand--</option>
                            </select>
                        </div>	
                        <div class="col-lg-3 col-sm-12">                         
                            <select name="ib_b22_slo_id_1" class="form-control form-group" id="ib_b22_slo_id_1"  >
                            <option value="">--Select SLO Statement--</option>
                            </select>
                        </div>				
                        <div class="col-lg-5 col-sm-12">                         
            ...
            <div class="row">
				...
				<div class="col-lg-11 col-sm-12">                         
                    <div class="row">
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b22_cs_id_2" class="form-control form-group" id="ib_b22_cs_id_2"  >
                            <option value="">--Select Content Stand--</option>
                            </select>
                        </div>				
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b22_scs_id_2" class="form-control form-group" id="ib_b22_scs_id_2"  >
                            <option value="">--Select SubContent Stand--</option>
                            </select>
                        </div>	
                        <div class="col-lg-3 col-sm-12">                         
                            <select name="ib_b22_slo_id_2" class="form-control form-group" id="ib_b22_slo_id_2"  >
                            <option value="">--Select SLO Statement--</option>
                            </select>
                        </div>				
                        <div class="col-lg-5 col-sm-12">                         
            ...
            <div class="row">
				...
				<div class="col-lg-11 col-sm-12">                         
                    <div class="row">
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b22_cs_id_3" class="form-control form-group" id="ib_b22_cs_id_3"  >
                            <option value="">--Select Content Stand--</option>
                            </select>
                        </div>				
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b22_scs_id_3" class="form-control form-group" id="ib_b22_scs_id_3"  >
                            <option value="">--Select SubContent Stand--</option>
                            </select>
                        </div>	
                        <div class="col-lg-3 col-sm-12">                         
                            <select name="ib_b22_slo_id_3" class="form-control form-group" id="ib_b22_slo_id_3"  >
                            <option value="">--Select SLO Statement--</option>
                            </select>
                        </div>				
                        <div class="col-lg-5 col-sm-12">                         
            ...
            <div class="row">
				...
				<div class="col-lg-11 col-sm-12">                         
                    <div class="row">
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b22_cs_id_4" class="form-control form-group" id="ib_b22_cs_id_4"  >
                            <option value="">--Select Content Stand--</option>
                            </select>
                        </div>				
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b22_scs_id_4" class="form-control form-group" id="ib_b22_scs_id_4"  >
                            <option value="">--Select SubContent Stand--</option>
                            </select>
                        </div>	
                        <div class="col-lg-3 col-sm-12">                         
                            <select name="ib_b22_slo_id_4" class="form-control form-group" id="ib_b22_slo_id_4"  >
                            <option value="">--Select SLO Statement--</option>
                            </select>
                        </div>				
                        <div class="col-lg-5 col-sm-12">                         
...
<!---------------------------------------------Start Block-23------------------------------------------------------------>             
            ...
            <div class="row">
				...
				<div class="col-lg-11 col-sm-12">                         
                    <div class="row">
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b23_cs_id_1" class="form-control form-group" id="ib_b23_cs_id_1"  >
                            <option value="">--Select Content Stand--</option>
                            </select>
                        </div>				
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b23_scs_id_1" class="form-control form-group" id="ib_b23_cs_id_1" >
                            <option value="">--Select SubContent Stand--</option>
                            </select>
                        </div>	
                        <div class="col-lg-3 col-sm-12">                         
                            <select name="ib_b23_slo_id_1" class="form-control form-group" id="ib_b23_slo_id_1"  >
                            <option value="">--Select SLO Statement--</option>
                            </select>
                        </div>				
                        <div class="col-lg-5 col-sm-12">                         
            ...
            <div class="row">
				...
				<div class="col-lg-11 col-sm-12">                         
                    <div class="row">
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b23_cs_id_2" class="form-control form-group" id="ib_b23_cs_id_2"  >
                            <option value="">--Select Content Stand--</option>
                            </select>
                        </div>				
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b23_scs_id_2" class="form-control form-group" id="ib_b23_scs_id_2"  >
                            <option value="">--Select SubContent Stand--</option>
                            </select>
                        </div>	
                        <div class="col-lg-3 col-sm-12">                         
                            <select name="ib_b23_slo_id_2" class="form-control form-group" id="ib_b23_slo_id_2"  >
                            <option value="">--Select SLO Statement--</option>
                            </select>
                        </div>				
                        <div class="col-lg-5 col-sm-12">                         
            ...
            <div class="row">
				...
				<div class="col-lg-11 col-sm-12">                         
                    <div class="row">
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b23_cs_id_3" class="form-control form-group" id="ib_b23_cs_id_3"  >
                            <option value="">--Select Content Stand--</option>
                            </select>
                        </div>				
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b23_scs_id_3" class="form-control form-group" id="ib_b23_scs_id_3"  >
                            <option value="">--Select SubContent Stand--</option>
                            </select>
                        </div>	
                        <div class="col-lg-3 col-sm-12">                         
                            <select name="ib_b23_slo_id_3" class="form-control form-group" id="ib_b23_slo_id_3"  >
                            <option value="">--Select SLO Statement--</option>
                            </select>
                        </div>				
                        <div class="col-lg-5 col-sm-12">                         
            ...
            <div class="row">
				...
				<div class="col-lg-11 col-sm-12">                         
                    <div class="row">
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b23_cs_id_4" class="form-control form-group" id="ib_b23_cs_id_4"  >
                            <option value="">--Select Content Stand--</option>
                            </select>
                        </div>				
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b23_scs_id_4" class="form-control form-group" id="ib_b23_scs_id_4"  >
                            <option value="">--Select SubContent Stand--</option>
                            </select>
                        </div>	
                        <div class="col-lg-3 col-sm-12">                         
                            <select name="ib_b23_slo_id_4" class="form-control form-group" id="ib_b23_slo_id_4"  >
                            <option value="">--Select SLO Statement--</option>
                            </select>
                        </div>				
                        <div class="col-lg-5 col-sm-12">                         
...
<!---------------------------------------------Start Block-24------------------------------------------------------------>             
            ...
            <div class="row">
				...
				<div class="col-lg-11 col-sm-12">                         
                    <div class="row">
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b24_cs_id_1" class="form-control form-group" id="ib_b24_cs_id_1"  >
                            <option value="">--Select Content Stand--</option>
                            </select>
                        </div>				
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b24_scs_id_1" class="form-control form-group" id="ib_b24_cs_id_1" >
                            <option value="">--Select SubContent Stand--</option>
                            </select>
                        </div>	
                        <div class="col-lg-3 col-sm-12">                         
                            <select name="ib_b24_slo_id_1" class="form-control form-group" id="ib_b24_slo_id_1"  >
                            <option value="">--Select SLO Statement--</option>
                            </select>
                        </div>				
                        <div class="col-lg-5 col-sm-12">                         
            ...
            <div class="row">
				...
				<div class="col-lg-11 col-sm-12">                         
                    <div class="row">
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b24_cs_id_2" class="form-control form-group" id="ib_b24_cs_id_2"  >
                            <option value="">--Select Content Stand--</option>
                            </select>
                        </div>				
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b24_scs_id_2" class="form-control form-group" id="ib_b24_scs_id_2"  >
                            <option value="">--Select SubContent Stand--</option>
                            </select>
                        </div>	
                        <div class="col-lg-3 col-sm-12">                         
                            <select name="ib_b24_slo_id_2" class="form-control form-group" id="ib_b24_slo_id_2"  >
                            <option value="">--Select SLO Statement--</option>
                            </select>
                        </div>				
                        <div class="col-lg-5 col-sm-12">                         
            ...
            <div class="row">
				...
				<div class="col-lg-11 col-sm-12">                         
                    <div class="row">
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b24_cs_id_3" class="form-control form-group" id="ib_b24_cs_id_3"  >
                            <option value="">--Select Content Stand--</option>
                            </select>
                        </div>				
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b24_scs_id_3" class="form-control form-group" id="ib_b24_scs_id_3"  >
                            <option value="">--Select SubContent Stand--</option>
                            </select>
                        </div>	
                        <div class="col-lg-3 col-sm-12">                         
                            <select name="ib_b24_slo_id_3" class="form-control form-group" id="ib_b24_slo_id_3"  >
                            <option value="">--Select SLO Statement--</option>
                            </select>
                        </div>				
                        <div class="col-lg-5 col-sm-12">                         
            ...
            <div class="row">
				...
				<div class="col-lg-11 col-sm-12">                         
                    <div class="row">
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b24_cs_id_4" class="form-control form-group" id="ib_b24_cs_id_4"  >
                            <option value="">--Select Content Stand--</option>
                            </select>
                        </div>				
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b24_scs_id_4" class="form-control form-group" id="ib_b24_scs_id_4"  >
                            <option value="">--Select SubContent Stand--</option>
                            </select>
                        </div>	
                        <div class="col-lg-3 col-sm-12">                         
                            <select name="ib_b24_slo_id_4" class="form-control form-group" id="ib_b24_slo_id_4"  >
                            <option value="">--Select SLO Statement--</option>
                            </select>
                        </div>				
                        <div class="col-lg-5 col-sm-12">                         
...
<!---------------------------------------------Start Block-25------------------------------------------------------------>             
            ...
            <div class="row">
				...
				<div class="col-lg-11 col-sm-12">                         
                    <div class="row">
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b25_cs_id_1" class="form-control form-group" id="ib_b25_cs_id_1"  >
                            <option value="">--Select Content Stand--</option>
                            </select>
                        </div>				
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b25_scs_id_1" class="form-control form-group" id="ib_b25_cs_id_1" >
                            <option value="">--Select SubContent Stand--</option>
                            </select>
                        </div>	
                        <div class="col-lg-3 col-sm-12">                         
                            <select name="ib_b25_slo_id_1" class="form-control form-group" id="ib_b25_slo_id_1"  >
                            <option value="">--Select SLO Statement--</option>
                            </select>
                        </div>				
                        <div class="col-lg-5 col-sm-12">                         
            ...
            <div class="row">
				...
				<div class="col-lg-11 col-sm-12">                         
                    <div class="row">
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b25_cs_id_2" class="form-control form-group" id="ib_b25_cs_id_2"  >
                            <option value="">--Select Content Stand--</option>
                            </select>
                        </div>				
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b25_scs_id_2" class="form-control form-group" id="ib_b25_scs_id_2"  >
                            <option value="">--Select SubContent Stand--</option>
                            </select>
                        </div>	
                        <div class="col-lg-3 col-sm-12">                         
                            <select name="ib_b25_slo_id_2" class="form-control form-group" id="ib_b25_slo_id_2"  >
                            <option value="">--Select SLO Statement--</option>
                            </select>
                        </div>				
                        <div class="col-lg-5 col-sm-12">                         
            ...
            <div class="row">
				...
				<div class="col-lg-11 col-sm-12">                         
                    <div class="row">
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b25_cs_id_3" class="form-control form-group" id="ib_b25_cs_id_3"  >
                            <option value="">--Select Content Stand--</option>
                            </select>
                        </div>				
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b25_scs_id_3" class="form-control form-group" id="ib_b25_scs_id_3"  >
                            <option value="">--Select SubContent Stand--</option>
                            </select>
                        </div>	
                        <div class="col-lg-3 col-sm-12">                         
                            <select name="ib_b25_slo_id_3" class="form-control form-group" id="ib_b25_slo_id_3"  >
                            <option value="">--Select SLO Statement--</option>
                            </select>
                        </div>				
                        <div class="col-lg-5 col-sm-12">                         
            ...
            <div class="row">
				...
				<div class="col-lg-11 col-sm-12">                         
                    <div class="row">
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b25_cs_id_4" class="form-control form-group" id="ib_b25_cs_id_4"  >
                            <option value="">--Select Content Stand--</option>
                            </select>
                        </div>				
                        <div class="col-lg-2 col-sm-12">                         
                            <select name="ib_b25_scs_id_4" class="form-control form-group" id="ib_b25_scs_id_4"  >
                            <option value="">--Select SubContent Stand--</option>
                            </select>
                        </div>	
                        <div class="col-lg-3 col-sm-12">                         
                            <select name="ib_b25_slo_id_4" class="form-control form-group" id="ib_b25_slo_id_4"  >
                            <option value="">--Select SLO Statement--</option>
                            </select>
                        </div>				
                        <div class="col-lg-5 col-sm-12">                         
    ...
    function(data){
     ...
     $('#ib_b1_item1')
         .append($("<option></option>")
                    ...
                    .text(value.item_id+':'+value.item_stem_en+'-'+value.item_stem_ur)					
                  ); 
        });   
    });
});
...
<!-----------------------------------End Block-25------------------------------------------------------------>\
<!-----------------------------------Start Block-1 check for same item------------------------------------------------------------>\
function onSubmitFunc()
{
	if($('#ib_b1_item1').val()==$('#ib_b1_item2').val()||$('#ib_b1_item1').val()==$('#ib_b1_item3').val()||$('#ib_b1_item1').val()==$('#ib_b1_item4').val())
	{	
		alert('Items Selection must be Unique in Each Block! Try another items.(1st with other 3s)');
		return false;
	}
	if($('#ib_b1_item2').val()==$('#ib_b1_item3').val()||$('#ib_b1_item2').val()==$('#ib_b1_item4').val())
	{
		alert('Items Selection must be Unique in Each Block! Try another items.(2nd with other 2s)');
		return false;
	}
	if($('#ib_b1_item3').val()==$('#ib_b1_item4').val())
	{
		alert('Items Selection must be Unique in Each Block! Try another items.(3rd with 4th');
		return false;
	}
	alert('success');
	return true;
}
<!-----------------------------------End Block-1 check for same item------------------------------------------------------------>\
<!-----------------------------------Start Block-2 check for same item------------------------------------------------------------>\
function onSubmitFunc()
{
	if($('#ib_b2_item1').val()==$('#ib_b2_item2').val()||$('#ib_b2_item1').val()==$('#ib_b2_item3').val()||$('#ib_b2_item1').val()==$('#ib_b2_item4').val())
	{	
		alert('Items Selection must be Unique in Each Block! Try another items.(1st with other 3s)');
		return false;
	}
	if($('#ib_b2_item2').val()==$('#ib_b2_item3').val()||$('#ib_b2_item2').val()==$('#ib_b2_item4').val())
	{
		alert('Items Selection must be Unique in Each Block! Try another items.(2nd with other 2s)');
		return false;
	}
	if($('#ib_b2_item3').val()==$('#ib_b2_item4').val())
	{
		alert('Items Selection must be Unique in Each Block! Try another items.(3rd with 4th');
		return false;
	}
...
<!-----------------------------------End Block-2 check for same item------------------------------------------------------------>\
<!-----------------------------------Start Block-3 check for same item------------------------------------------------------------>\
function onSubmitFunc()
{
	if($('#ib_b3_item1').val()==$('#ib_b3_item2').val()||$('#ib_b3_item1').val()==$('#ib_b3_item3').val()||$('#ib_b3_item1').val()==$('#ib_b3_item4').val())
	{	
		alert('Items Selection must be Unique in Each Block! Try another items.(1st with other 3s)');
		return false;
	}
	if($('#ib_b3_item2').val()==$('#ib_b3_item3').val()||$('#ib_b3_item2').val()==$('#ib_b3_item4').val())
	{
		alert('Items Selection must be Unique in Each Block! Try another items.(2nd with other 2s)');
		return false;
	}
	if($('#ib_b3_item3').val()==$('#ib_b3_item4').val())
	{
		alert('Items Selection must be Unique in Each Block! Try another items.(3rd with 4th');
		return false;
	}
...
<!-----------------------------------End Block-3 check for same item------------------------------------------------------------>\
<!-----------------------------------Start Block-4 check for same item------------------------------------------------------------>\
function onSubmitFunc()
{
	if($('#ib_b4_item1').val()==$('#ib_b4_item2').val()||$('#ib_b4_item1').val()==$('#ib_b4_item3').val()||$('#ib_b4_item1').val()==$('#ib_b4_item4').val())
	{	
		alert('Items Selection must be Unique in Each Block! Try another items.(1st with other 3s)');
		return false;
	}
	if($('#ib_b4_item2').val()==$('#ib_b4_item3').val()||$('#ib_b4_item2').val()==$('#ib_b4_item4').val())
	{
		alert('Items Selection must be Unique in Each Block! Try another items.(2nd with other 2s)');
		return false;
	}
	if($('#ib_b4_item3').val()==$('#ib_b4_item4').val())
	{
		alert('Items Selection must be Unique in Each Block! Try another items.(3rd with 4th');
		return false;
	}
...
<!-----------------------------------End Block-4 check for same item------------------------------------------------------------>\
<!-----------------------------------Start Block-5 check for same item------------------------------------------------------------>\
function onSubmitFunc()
{
	if($('#ib_b5_item1').val()==$('#ib_b5_item2').val()||$('#ib_b5_item1').val()==$('#ib_b5_item3').val()||$('#ib_b5_item1').val()==$('#ib_b5_item4').val())
	{	
		alert('Items Selection must be Unique in Each Block! Try another items.(1st with other 3s)');
		return false;
	}
	if($('#ib_b5_item2').val()==$('#ib_b5_item3').val()||$('#ib_b5_item2').val()==$('#ib_b5_item4').val())
	{
		alert('Items Selection must be Unique in Each Block! Try another items.(2nd with other 2s)');
		return false;
	}
	if($('#ib_b5_item3').val()==$('#ib_b5_item4').val())
	{
		alert('Items Selection must be Unique in Each Block! Try another items.(3rd with 4th');
		return false;
	}
...
<!-----------------------------------End Block-5 check for same item------------------------------------------------------------>\
<!-----------------------------------Start Block-6 check for same item------------------------------------------------------------>\
function onSubmitFunc()
{
	if($('#ib_b6_item1').val()==$('#ib_b6_item2').val()||$('#ib_b6_item1').val()==$('#ib_b6_item3').val()||$('#ib_b6_item1').val()==$('#ib_b6_item4').val())
	{	
		alert('Items Selection must be Unique in Each Block! Try another items.(1st with other 3s)');
		return false;
	}
	if($('#ib_b6_item2').val()==$('#ib_b6_item3').val()||$('#ib_b6_item2').val()==$('#ib_b6_item4').val())
	{
		alert('Items Selection must be Unique in Each Block! Try another items.(2nd with other 2s)');
		return false;
	}
	if($('#ib_b6_item3').val()==$('#ib_b6_item4').val())
	{
		alert('Items Selection must be Unique in Each Block! Try another items.(3rd with 4th');
		return false;
	}
...
<!-----------------------------------End Block-6 check for same item------------------------------------------------------------>\
<!-----------------------------------Start Block-7 check for same item------------------------------------------------------------>\
function onSubmitFunc()
{
	if($('#ib_b7_item1').val()==$('#ib_b7_item2').val()||$('#ib_b7_item1').val()==$('#ib_b7_item3').val()||$('#ib_b7_item1').val()==$('#ib_b7_item4').val())
	{	
		alert('Items Selection must be Unique in Each Block! Try another items.(1st with other 3s)');
		return false;
	}
	if($('#ib_b7_item2').val()==$('#ib_b7_item3').val()||$('#ib_b7_item2').val()==$('#ib_b7_item4').val())
	{
		alert('Items Selection must be Unique in Each Block! Try another items.(2nd with other 2s)');
		return false;
	}
	if($('#ib_b7_item3').val()==$('#ib_b7_item4').val())
	{
		alert('Items Selection must be Unique in Each Block! Try another items.(3rd with 4th');
		return false;
	}
...
<!-----------------------------------End Block-7 check for same item------------------------------------------------------------>\
<!-----------------------------------Start Block-8 check for same item------------------------------------------------------------>\
function onSubmitFunc()
{
	if($('#ib_b8_item1').val()==$('#ib_b8_item2').val()||$('#ib_b8_item1').val()==$('#ib_b8_item3').val()||$('#ib_b8_item1').val()==$('#ib_b8_item4').val())
	{	
		alert('Items Selection must be Unique in Each Block! Try another items.(1st with other 3s)');
		return false;
	}
	if($('#ib_b8_item2').val()==$('#ib_b8_item3').val()||$('#ib_b8_item2').val()==$('#ib_b8_item4').val())
	{
		alert('Items Selection must be Unique in Each Block! Try another items.(2nd with other 2s)');
		return false;
	}
	if($('#ib_b8_item3').val()==$('#ib_b8_item4').val())
	{
		alert('Items Selection must be Unique in Each Block! Try another items.(3rd with 4th');
		return false;
	}
...
<!-----------------------------------End Block-8 check for same item------------------------------------------------------------>\
<!-----------------------------------Start Block-9 check for same item------------------------------------------------------------>\
function onSubmitFunc()
{
	if($('#ib_b9_item1').val()==$('#ib_b9_item2').val()||$('#ib_b9_item1').val()==$('#ib_b9_item3').val()||$('#ib_b9_item1').val()==$('#ib_b9_item4').val())
	{	
		alert('Items Selection must be Unique in Each Block! Try another items.(1st with other 3s)');
		return false;
	}
	if($('#ib_b9_item2').val()==$('#ib_b9_item3').val()||$('#ib_b9_item2').val()==$('#ib_b9_item4').val())
	{
		alert('Items Selection must be Unique in Each Block! Try another items.(2nd with other 2s)');
		return false;
	}
	if($('#ib_b9_item3').val()==$('#ib_b9_item4').val())
	{
		alert('Items Selection must be Unique in Each Block! Try another items.(3rd with 4th');
		return false;
	}
...
<!-----------------------------------End Block-9 check for same item------------------------------------------------------------>\
<!-----------------------------------Start Block-10 check for same item------------------------------------------------------------>\
function onSubmitFunc()
{
	if($('#ib_b10_item1').val()==$('#ib_b10_item2').val()||$('#ib_b10_item1').val()==$('#ib_b10_item3').val()||$('#ib_b10_item1').val()==$('#ib_b10_item4').val())
	{	
		alert('Items Selection must be Unique in Each Block! Try another items.(1st with other 3s)');
		return false;
	}
	if($('#ib_b10_item2').val()==$('#ib_b10_item3').val()||$('#ib_b10_item2').val()==$('#ib_b10_item4').val())
	{
		alert('Items Selection must be Unique in Each Block! Try another items.(2nd with other 2s)');
		return false;
	}
	if($('#ib_b10_item3').val()==$('#ib_b10_item4').val())
	{
		alert('Items Selection must be Unique in Each Block! Try another items.(3rd with 4th');
		return false;
	}
...
<!-----------------------------------End Block-10 check for same item------------------------------------------------------------>\
<!-----------------------------------Start Block-11 check for same item------------------------------------------------------------>\
function onSubmitFunc()
{
	if($('#ib_b11_item1').val()==$('#ib_b11_item2').val()||$('#ib_b11_item1').val()==$('#ib_b11_item3').val()||$('#ib_b11_item1').val()==$('#ib_b11_item4').val())
	{	
		alert('Items Selection must be Unique in Each Block! Try another items.(1st with other 3s)');
		return false;
	}
	if($('#ib_b11_item2').val()==$('#ib_b11_item3').val()||$('#ib_b11_item2').val()==$('#ib_b11_item4').val())
	{
		alert('Items Selection must be Unique in Each Block! Try another items.(2nd with other 2s)');
		return false;
	}
	if($('#ib_b11_item3').val()==$('#ib_b11_item4').val())
	{
		alert('Items Selection must be Unique in Each Block! Try another items.(3rd with 4th');
		return false;
	}
...
<!-----------------------------------End Block-11 check for same item------------------------------------------------------------>\
<!-----------------------------------Start Block-12 check for same item------------------------------------------------------------>\
function onSubmitFunc()
{
	if($('#ib_b12_item1').val()==$('#ib_b12_item2').val()||$('#ib_b12_item1').val()==$('#ib_b12_item3').val()||$('#ib_b12_item1').val()==$('#ib_b12_item4').val())
	{	
		alert('Items Selection must be Unique in Each Block! Try another items.(1st with other 3s)');
		return false;
	}
	if($('#ib_b12_item2').val()==$('#ib_b12_item3').val()||$('#ib_b12_item2').val()==$('#ib_b12_item4').val())
	{
		alert('Items Selection must be Unique in Each Block! Try another items.(2nd with other 2s)');
		return false;
	}
	if($('#ib_b12_item3').val()==$('#ib_b12_item4').val())
	{
		alert('Items Selection must be Unique in Each Block! Try another items.(3rd with 4th');
		return false;
	}
...
<!-----------------------------------End Block-12 check for same item------------------------------------------------------------>\
<!-----------------------------------Start Block-13 check for same item------------------------------------------------------------>\
function onSubmitFunc()
{
	if($('#ib_b13_item1').val()==$('#ib_b13_item2').val()||$('#ib_b13_item1').val()==$('#ib_b13_item3').val()||$('#ib_b13_item1').val()==$('#ib_b13_item4').val())
	{	
		alert('Items Selection must be Unique in Each Block! Try another items.(1st with other 3s)');
		return false;
	}
	if($('#ib_b13_item2').val()==$('#ib_b13_item3').val()||$('#ib_b13_item2').val()==$('#ib_b13_item4').val())
	{
		alert('Items Selection must be Unique in Each Block! Try another items.(2nd with other 2s)');
		return false;
	}
	if($('#ib_b13_item3').val()==$('#ib_b13_item4').val())
	{
		alert('Items Selection must be Unique in Each Block! Try another items.(3rd with 4th');
		return false;
	}
...
<!-----------------------------------End Block-13 check for same item------------------------------------------------------------>\
<!-----------------------------------Start Block-14 check for same item------------------------------------------------------------>\
function onSubmitFunc()
{
	if($('#ib_b14_item1').val()==$('#ib_b14_item2').val()||$('#ib_b14_item1').val()==$('#ib_b14_item3').val()||$('#ib_b14_item1').val()==$('#ib_b14_item4').val())
	{	
		alert('Items Selection must be Unique in Each Block! Try another items.(1st with other 3s)');
		return false;
	}
	if($('#ib_b14_item2').val()==$('#ib_b14_item3').val()||$('#ib_b14_item2').val()==$('#ib_b14_item4').val())
	{
		alert('Items Selection must be Unique in Each Block! Try another items.(2nd with other 2s)');
		return false;
	}
	if($('#ib_b14_item3').val()==$('#ib_b14_item4').val())
	{
		alert('Items Selection must be Unique in Each Block! Try another items.(3rd with 4th');
		return false;
	}
...
<!-----------------------------------End Block-14 check for same item------------------------------------------------------------>\
<!-----------------------------------Start Block-15 check for same item------------------------------------------------------------>\
function onSubmitFunc()
{
	if($('#ib_b15_item1').val()==$('#ib_b15_item2').val()||$('#ib_b15_item1').val()==$('#ib_b15_item3').val()||$('#ib_b15_item1').val()==$('#ib_b15_item4').val())
	{	
		alert('Items Selection must be Unique in Each Block! Try another items.(1st with other 3s)');
		return false;
	}
	if($('#ib_b15_item2').val()==$('#ib_b15_item3').val()||$('#ib_b15_item2').val()==$('#ib_b15_item4').val())
	{
		alert('Items Selection must be Unique in Each Block! Try another items.(2nd with other 2s)');
		return false;
	}
	if($('#ib_b15_item3').val()==$('#ib_b15_item4').val())
	{
		alert('Items Selection must be Unique in Each Block! Try another items.(3rd with 4th');
		return false;
	}
...
<!-----------------------------------End Block-15 check for same item------------------------------------------------------------>\
<?php /*?>
<!-----------------------------------Start Block-16 check for same item------------------------------------------------------------>\
function onSubmitFunc()
{
	if($('#ib_b16_item1').val()==$('#ib_b16_item2').val()||$('#ib_b16_item1').val()==$('#ib_b16_item3').val()||$('#ib_b16_item1').val()==$('#ib_b16_item4').val())
	{	
		alert('Items Selection must be Unique in Each Block! Try another items.(1st with other 3s)');
		return false;
	}
	if($('#ib_b16_item2').val()==$('#ib_b16_item3').val()||$('#ib_b16_item2').val()==$('#ib_b16_item4').val())
	{
		alert('Items Selection must be Unique in Each Block! Try another items.(2nd with other 2s)');
		return false;
	}
	if($('#ib_b16_item3').val()==$('#ib_b16_item4').val())
	{
		alert('Items Selection must be Unique in Each Block! Try another items.(3rd with 4th');
		return false;
	}
...
<!-----------------------------------End Block-16 check for same item------------------------------------------------------------>\
<!-----------------------------------Start Block-17 check for same item------------------------------------------------------------>\
function onSubmitFunc()
{
	if($('#ib_b17_item1').val()==$('#ib_b17_item2').val()||$('#ib_b17_item1').val()==$('#ib_b17_item3').val()||$('#ib_b17_item1').val()==$('#ib_b17_item4').val())
	{	
		alert('Items Selection must be Unique in Each Block! Try another items.(1st with other 3s)');
		return false;
	}
	if($('#ib_b17_item2').val()==$('#ib_b17_item3').val()||$('#ib_b17_item2').val()==$('#ib_b17_item4').val())
	{
		alert('Items Selection must be Unique in Each Block! Try another items.(2nd with other 2s)');
		return false;
	}
	if($('#ib_b17_item3').val()==$('#ib_b17_item4').val())
	{
		alert('Items Selection must be Unique in Each Block! Try another items.(3rd with 4th');
		return false;
	}
...
<!-----------------------------------End Block-17 check for same item------------------------------------------------------------>\
<!-----------------------------------Start Block-18 check for same item------------------------------------------------------------>\
function onSubmitFunc()
{
	if($('#ib_b18_item1').val()==$('#ib_b18_item2').val()||$('#ib_b18_item1').val()==$('#ib_b18_item3').val()||$('#ib_b18_item1').val()==$('#ib_b18_item4').val())
	{	
		alert('Items Selection must be Unique in Each Block! Try another items.(1st with other 3s)');
		return false;
	}
	if($('#ib_b18_item2').val()==$('#ib_b18_item3').val()||$('#ib_b18_item2').val()==$('#ib_b18_item4').val())
	{
		alert('Items Selection must be Unique in Each Block! Try another items.(2nd with other 2s)');
		return false;
	}
	if($('#ib_b18_item3').val()==$('#ib_b18_item4').val())
	{
		alert('Items Selection must be Unique in Each Block! Try another items.(3rd with 4th');
		return false;
	}
...
<!-----------------------------------End Block-18 check for same item------------------------------------------------------------>\
<!-----------------------------------Start Block-19 check for same item------------------------------------------------------------>\
function onSubmitFunc()
{
	if($('#ib_b19_item1').val()==$('#ib_b19_item2').val()||$('#ib_b19_item1').val()==$('#ib_b19_item3').val()||$('#ib_b19_item1').val()==$('#ib_b19_item4').val())
	{	
		alert('Items Selection must be Unique in Each Block! Try another items.(1st with other 3s)');
		return false;
	}
	if($('#ib_b19_item2').val()==$('#ib_b19_item3').val()||$('#ib_b19_item2').val()==$('#ib_b19_item4').val())
	{
		alert('Items Selection must be Unique in Each Block! Try another items.(2nd with other 2s)');
		return false;
	}
	if($('#ib_b19_item3').val()==$('#ib_b19_item4').val())
	{
		alert('Items Selection must be Unique in Each Block! Try another items.(3rd with 4th');
		return false;
	}
...
<!-----------------------------------End Block-19 check for same item------------------------------------------------------------>\
<!-----------------------------------Start Block-20 check for same item------------------------------------------------------------>\
function onSubmitFunc()
{
	if($('#ib_b20_item1').val()==$('#ib_b20_item2').val()||$('#ib_b20_item1').val()==$('#ib_b20_item3').val()||$('#ib_b20_item1').val()==$('#ib_b20_item4').val())
	{	
		alert('Items Selection must be Unique in Each Block! Try another items.(1st with other 3s)');
		return false;
	}
	if($('#ib_b20_item2').val()==$('#ib_b20_item3').val()||$('#ib_b20_item2').val()==$('#ib_b20_item4').val())
	{
		alert('Items Selection must be Unique in Each Block! Try another items.(2nd with other 2s)');
		return false;
	}
	if($('#ib_b20_item3').val()==$('#ib_b20_item4').val())
	{
		alert('Items Selection must be Unique in Each Block! Try another items.(3rd with 4th');
		return false;
	}
...
<!-----------------------------------End Block-20 check for same item------------------------------------------------------------>\
<!-----------------------------------Start Block-21 check for same item------------------------------------------------------------>\
function onSubmitFunc()
{
	if($('#ib_b21_item1').val()==$('#ib_b21_item2').val()||$('#ib_b21_item1').val()==$('#ib_b21_item3').val()||$('#ib_b21_item1').val()==$('#ib_b21_item4').val())
	{	
		alert('Items Selection must be Unique in Each Block! Try another items.(1st with other 3s)');
		return false;
	}
	if($('#ib_b21_item2').val()==$('#ib_b21_item3').val()||$('#ib_b21_item2').val()==$('#ib_b21_item4').val())
	{
		alert('Items Selection must be Unique in Each Block! Try another items.(2nd with other 2s)');
		return false;
	}
	if($('#ib_b21_item3').val()==$('#ib_b21_item4').val())
	{
		alert('Items Selection must be Unique in Each Block! Try another items.(3rd with 4th');
		return false;
	}
...
<!-----------------------------------End Block-21 check for same item------------------------------------------------------------>\
<!-----------------------------------Start Block-22 check for same item------------------------------------------------------------>\
function onSubmitFunc()
{
	if($('#ib_b22_item1').val()==$('#ib_b22_item2').val()||$('#ib_b22_item1').val()==$('#ib_b22_item3').val()||$('#ib_b22_item1').val()==$('#ib_b22_item4').val())
	{	
		alert('Items Selection must be Unique in Each Block! Try another items.(1st with other 3s)');
		return false;
	}
	if($('#ib_b22_item2').val()==$('#ib_b22_item3').val()||$('#ib_b22_item2').val()==$('#ib_b22_item4').val())
	{
		alert('Items Selection must be Unique in Each Block! Try another items.(2nd with other 2s)');
		return false;
	}
	if($('#ib_b22_item3').val()==$('#ib_b22_item4').val())
	{
		alert('Items Selection must be Unique in Each Block! Try another items.(3rd with 4th');
		return false;
	}
...
<!-----------------------------------End Block-22 check for same item------------------------------------------------------------>\
<!-----------------------------------Start Block-23 check for same item------------------------------------------------------------>\
function onSubmitFunc()
{
	if($('#ib_b23_item1').val()==$('#ib_b23_item2').val()||$('#ib_b23_item1').val()==$('#ib_b23_item3').val()||$('#ib_b23_item1').val()==$('#ib_b23_item4').val())
	{	
		alert('Items Selection must be Unique in Each Block! Try another items.(1st with other 3s)');
		return false;
	}
	if($('#ib_b23_item2').val()==$('#ib_b23_item3').val()||$('#ib_b23_item2').val()==$('#ib_b23_item4').val())
	{
		alert('Items Selection must be Unique in Each Block! Try another items.(2nd with other 2s)');
		return false;
	}
	if($('#ib_b23_item3').val()==$('#ib_b23_item4').val())
	{
		alert('Items Selection must be Unique in Each Block! Try another items.(3rd with 4th');
		return false;
	}
...
<!-----------------------------------End Block-23 check for same item------------------------------------------------------------>\
<!-----------------------------------Start Block-24 check for same item------------------------------------------------------------>\
function onSubmitFunc()
{
	if($('#ib_b24_item1').val()==$('#ib_b24_item2').val()||$('#ib_b24_item1').val()==$('#ib_b24_item3').val()||$('#ib_b24_item1').val()==$('#ib_b24_item4').val())
	{	
		alert('Items Selection must be Unique in Each Block! Try another items.(1st with other 3s)');
		return false;
	}
	if($('#ib_b24_item2').val()==$('#ib_b24_item3').val()||$('#ib_b24_item2').val()==$('#ib_b24_item4').val())
	{
		alert('Items Selection must be Unique in Each Block! Try another items.(2nd with other 2s)');
		return false;
	}
	if($('#ib_b24_item3').val()==$('#ib_b24_item4').val())
	{
		alert('Items Selection must be Unique in Each Block! Try another items.(3rd with 4th');
		return false;
	}
...
<!-----------------------------------End Block-24 check for same item------------------------------------------------------------>\
<!-----------------------------------Start Block-25 check for same item------------------------------------------------------------>\
function onSubmitFunc()
{
	if($('#ib_b25_item1').val()==$('#ib_b25_item2').val()||$('#ib_b25_item1').val()==$('#ib_b25_item3').val()||$('#ib_b25_item1').val()==$('#ib_b25_item4').val())
	{	
		alert('Items Selection must be Unique in Each Block! Try another items.(1st with other 3s)');
		return false;
	}
	if($('#ib_b25_item2').val()==$('#ib_b25_item3').val()||$('#ib_b25_item2').val()==$('#ib_b25_item4').val())
	{
		alert('Items Selection must be Unique in Each Block! Try another items.(2nd with other 2s)');
		return false;
	}
	if($('#ib_b25_item3').val()==$('#ib_b25_item4').val())
	{
		alert('Items Selection must be Unique in Each Block! Try another items.(3rd with 4th');
		return false;
	}
...
<!-----------------------------------End Block-25 check for same item------------------------------------------------------------>\
<?php */?></script>

           ...
           <!-- For Messages -->
			...
			<input type="hidden" id="ci_ir_adminid" name="ci_ir_adminid" value="<?= $itemreviewers['ci_ir_adminid']; ?>" />
              ...
              <div class="row">                
                ...
                <div class="form-group col-lg-3 col-sm-12" id="div_sel_roles">
                ...
                <div class="col-lg-3 col-sm-12">
					<?php if ($itemreviewers['ci_ir_cniccopy'] != ""){?><a href="<?php echo base_url().$itemreviewers['ci_ir_cniccopy'];?>" target="_blank"><img src="<?php echo base_url().$itemreviewers['ci_ir_cniccopy'];?>" style="max-height:100px; max-width:100px;"/> </a><a class="delete btn btn-sm btn-danger" href='<?php echo base_url("admin/itemreviewers/delete_cniccopy/". $itemreviewers['ci_ir_id']); ?>' title="Delete" onclick="return confirm(\'Do you want to delete ?\')"><i class="fa fa-trash-o"></i></a><?php }?>
                </div>
                <div class="col-lg-3 col-sm-12">
					<?php if ($itemreviewers['ci_ir_picture'] != ""){?><a href="<?php echo base_url().$itemreviewers['ci_ir_picture'];?>" target="_blank"><img src="<?php echo base_url().$itemreviewers['ci_ir_picture'];?>" style="max-height:100px; max-width:100px;"/></a><a class="delete btn btn-sm btn-danger" href='<?php echo base_url("admin/itemreviewers/delete_picture/". $itemreviewers['ci_ir_id']); ?>' title="Delete" onclick="return confirm(\'Do you want to delete ?\')"><i class="fa fa-trash-o"></i></a><?php }?>
                </div>
              </div>

  <?php //die('Item writer Registration Form');?>
      ...
      <div class="card card-default color-palette-bo">
        <div class="card-header">
          <div class="d-inline-block">
              ...
              <strong>ITEM WRITER REGISTRATION FORM</strong></h3>
          </div>
        ...
        <div class="card-body">   
           <!-- For Messages -->
            ...
            <?php echo form_open(base_url('admin/itemwriters/add'), 'class="form-horizontal" name="frm_itmewriter_add" id="frm_itmewriters_add" method="POST" enctype="multipart/form-data" ');  ?> 
              <div class="row">                                        
...
$('#email').on('blur', function() {
      $.post('<?=base_url("admin/itemwriters/email_exist")?>',
    {
      '<?php echo $this->security->get_csrf_token_name(); ?>' : '<?php echo $this->security->get_csrf_hash(); ?>',
      email : this.value
    },

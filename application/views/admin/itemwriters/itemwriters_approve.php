      ...
      <div class="card card-default color-palette-bo">
        <div class="card-header">
          <div class="d-inline-block">
              ...
              &nbsp; Approval Form of Itemwriters </h3>
          </div>
          <div class="d-inline-block float-right">
            <a href="<?= base_url('admin/admin'); ?>" class="btn btn-success"><i class="fa fa-list"></i>  Itemwriters List</a>
          </div>
        </div>
        <div class="card-body">   
           <!-- For Messages -->
            ...
            <?php //echo '<PRE>';
			//print_r($subjects); ?>
            <?php echo form_open(base_url('admin/itemwriters/itemwriter_approve/'.$itemwriters['ci_iw_id']), 'class="form-horizontal"' )?> 
              <div class="row">                                         
                <div class="col-lg-3 col-sm-12">
                <label for="itemwritersname" class="col-sm-12 control-label">itemwriters Name(Unique)</label>
                  <input type="text" name="itemwritersname" value="<?= $itemwriters['ci_iw_username']; ?>" class="form-control" id="itemwritersname" placeholder="" readonly="readonly">
                </div>
                <div class="col-lg-3 col-sm-12">
                ...
                <label for="firstname" class="col-sm-12 control-label">First Name</label>
                  <input type="text" name="firstname" class="form-control form-group" id="firstname" value="<?= $itemwriters['ci_iw_fname']; ?>" placeholder="" required="required" readonly="readonly">
                </div>                  
                <div class="col-lg-3 col-sm-12">
                <label for="lastname" class="col-sm-12 control-label">Last Name</label>
                  <input type="text" name="lastname" class="form-control form-group" id="lastname" value="<?= $itemwriters['ci_iw_lname']; ?>" placeholder="" required="required" readonly="readonly">
                </div>
              </div>
              <div class="row">                
              <div class="col-lg-3 col-sm-12">
                <label for="email" class="col-sm-12 control-label">Email</label>
                  <input type="email" name="email" class="form-control form-group" id="email"  value="<?= $itemwriters['ci_iw_email']; ?>" placeholder="" required="required" readonly="readonly">
                </div>                
                <div class="col-lg-3 col-sm-12">
                <label for="mobile_no" class="col-sm-12 control-label">Mobile No</label>
                  <input type="number" name="mobile_no" class="form-control form-group" id="mobile_no" value="<?= $itemwriters['ci_iw_mobile']; ?>" placeholder="" required="required" readonly="readonly">
                </div>
                  <div class="col-lg-3 col-sm-12">
                    <label for="address" class="col-sm-12 control-label">Address</label>
                    <input type="text" name="address" class="form-control" id="address" value="<?= $itemwriters['ci_iw_posting']; ?>" placeholder="" required="required" readonly="readonly">
                  </div>
 				  <div class="col-lg-3 col-sm-12">  
                    <label for="is_active" class="col-sm-12 control-label">Itemwriters Status</label>
              ...
              <div class="form-group row">
              	<div class="col-lg-3 col-sm-12">
                    ...
                    <input type="text" name="address" class="form-control" id="address" value="<?= $itemwriters['ci_iw_subject']; ?>" placeholder="" required="required" readonly="readonly">
                  </div>
              	<div class="col-lg-3 col-sm-12"> 
              ...
              <div class="form-group">
                <div class="col-md-12">
                  <input type="submit" name="submit" value="Approve Itemwriters" class="btn btn-info pull-right">
                </div>
              </div>
            <?php echo form_close(); ?>
        </div>

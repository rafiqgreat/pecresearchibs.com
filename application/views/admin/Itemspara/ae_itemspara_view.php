...
?>               
          ...
          <div class="row"><div class="col-lg-12 col-sm-12"><hr/ ></div></div>
            ...
            <?php if($itemspara->para_status_ae=='0'){?>
            <?php echo form_open(base_url('admin/itemspara/ae_submit_for_approval/'.$itemspara->para_id), 'class="form-horizontal" enctype="multipart/form-data" ');  ?>  
                <div style="padding-top:15px; margin-left:5px">
                    <label for="para_comment_ae" class="col-sm-6 control-label">Comments</label>
                    <textarea id="para_comment_ae" name="para_comment_ae" rows="4" cols="55" style="width:100%" required="required"></textarea>
                    <input type="submit" name="approve" id="approve" value="Approve" class="btn btn-success pull-right" style="margin:5px">
                    <input type="submit" name="reject" id="reject" value="Reject" class="btn btn-danger pull-right" style="margin:5px">
                </div>
             <?php echo form_close( );} ?>
        </div>
      </div>
...
(function() {
      ...
      CKEDITOR.replace('para_comment_ae', {

      ...
      <div class="card card-default color-palette-bo">
        ...
        <div class="card-body">   
           <!-- For Messages -->
            ...
            <?php echo form_open(base_url('admin/itemspara/edit/'.$paragraph->para_id), 'class="form-horizontal" enctype="multipart/form-data" ');  ?>  
            ...
            <div class="row">             
                <div class="col-lg-6 col-sm-12">                         
                    <label for="para_text_en" class="control-label" style="line-height:40px">Para (English) *</label>
                	<textarea id="para_text_en" name="para_text_en"  class="form-control form-group" ><?php echo $paragraph->para_text_en; ?></textarea>
                </div>
				   <div class="col-lg-6 col-sm-12">                         
                    <label for="para_text_ur" class="col-sm-12 control-label urdufont-right" style="text-align:right; line-height:40px"> پیرا گراف  ( اردو) *</label>
             ...
             <div class="row">
              ...
              <div class="form-group">
                <div class="col-md-12">
                  ...
                  <?php /*if($this->session->userdata('role_id')==2){?><input type="submit" name="submit2" id="submit2" value="Submit with Change" class="btn btn-info pull-right" style="margin-right:15px"><?php }*/?>
                </div>
              </div>
            <?php echo form_close( ); ?>
          <!-- /.box-body -->

    ...
    <div class="card">
      <div class="card-header">
        <div class="d-inline-block">
          <h3 class="card-title"><i class="fa fa-list"></i>&nbsp; Items Paragraph List (Approved by SS)</h3>
        </div>
        ...
        <table id="na_datatable" class="table table-bordered table-striped" width="100%">
          <thead>
            <tr>
              ...
              <th style="width:40%">Paragraph Text</th>
              <th>Grade</th>
              <th>Subject</th>
              <th>Status SS</th>
              <th>Status AE</th>
...
<script>
  ...
  var table = $('#na_datatable').DataTable( {
    "processing": true,
    "serverSide": true,
    "ajax": "<?=base_url('admin/itemspara/datatable_json_ae_itempara'.((isset($para_subject_id)&&$para_subject_id!="")?'/'.$para_subject_id:''));?>",
  //  "order": [[1,'desc']],
    "columnDefs": [
    { "targets": 0, "name": "para_id", 'searchable':true, 'orderable':true},
	{ "targets": 1, "name": "para_title_en", 'searchable':true, 'orderable':true},
    { "targets": 2, "name": "para_text_en", 'searchable':true, 'orderable':true},
    { "targets": 3, "name": "para_grade_id", 'searchable':true, 'orderable':true},
    { "targets": 4, "name": "para_subject_id", 'searchable':true, 'orderable':true},
	{ "targets": 5, "name": "para_status_ss", 'searchable':true, 'orderable':true},
	{ "targets": 6, "name": "para_status_ae", 'searchable':true, 'orderable':true},

...
?>               
          ...
          <div class="row"><div class="col-lg-12 col-sm-12"><hr/ ></div></div>
            ...
            <?php if($itemspara->para_status_ss==0){?>
			 <?php echo form_open(base_url('admin/itemspara/ss_submit_for_approval/'.$itemspara->para_id), 'class="form-horizontal" enctype="multipart/form-data" ');  ?>  
                <div style="padding-top:15px; margin-left:5px">
                    <label for="para_comment_ss" class="col-sm-6 control-label">Comments</label>
                    <textarea id="para_comment_ss" name="para_comment_ss" rows="4" cols="55" style="width:100%" ></textarea>
                    ...
                    <a href=<?php echo base_url('admin/itemspara/edit/'.$itemspara->para_id); ?>><input type="button" name="edit" id="edit" value="Edit Item Para" class="btn btn-info pull-right" style="margin:5px"></a> 
                </div>

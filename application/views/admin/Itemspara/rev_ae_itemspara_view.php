    ...
    <section class="content">
      <div class="card card-default color-palette-bo">
	   ...
	   <?php 
			...
			$status_pi_21 = (isset($status_pi_21)&&!empty($status_pi_21))?$status_pi_21[0]->item_rev_ae_status:0;
			$status_pi_22 = (isset($status_pi_22)&&!empty($status_pi_22))?$status_pi_22[0]->item_rev_ae_status:0;
			$status_pi_23 = (isset($status_pi_23)&&!empty($status_pi_23))?$status_pi_23[0]->item_rev_ae_status:0;
			$status_pi_24 = (isset($status_pi_24)&&!empty($status_pi_24))?$status_pi_24[0]->item_rev_ae_status:0;
			$status_pi_25 = (isset($status_pi_25)&&!empty($status_pi_25))?$status_pi_25[0]->item_rev_ae_status:0;
			$status_pi_26 = (isset($status_pi_26)&&!empty($status_pi_26))?$status_pi_26[0]->item_rev_ae_status:0;
			$status_pi_27 = (isset($status_pi_27)&&!empty($status_pi_27))?$status_pi_27[0]->item_rev_ae_status:0;
			$status_pi_28 = (isset($status_pi_28)&&!empty($status_pi_28))?$status_pi_28[0]->item_rev_ae_status:0;
			$status_pi_29 = (isset($status_pi_29)&&!empty($status_pi_29))?$status_pi_29[0]->item_rev_ae_status:0;
			$status_pi_30 = (isset($status_pi_30)&&!empty($status_pi_30))?$status_pi_30[0]->item_rev_ae_status:0;
...
?>               
        	...
        	<table width="100%" border="1" style="text-align:center; margin-left:05px">
             ...
             <?php if($itemspara->para_rev_comment!=""){?>
              ...
              <tr>
                ...
                <td><?php if($itemspara->para_rev_ss_status==0){echo "Pending";}elseif($itemspara->para_rev_ss_status==1){echo "Under Review";}elseif($itemspara->para_rev_ss_status==2){echo "Accepted";}?></td>
     ...
     <?php echo form_open(base_url('admin/itemspara/rev_ae_submit_for_approval/'.$itemspara->para_id), 'class="form-horizontal" enctype="multipart/form-data" ');  ?>  
    	<div style="padding-top:15px; margin-left:5px">
			...
			switch($total_items)
			{
				...
				{
					?>
                    <label for="para_rev_ae_comment" class="col-sm-6 control-label">Reviewer Comments</label>
                    <textarea id="para_rev_ae_comment" name="para_rev_ae_comment" rows="4" cols="55" style="width:100%" ></textarea>
            ...
            <a href=<?php echo base_url('admin/itemspara/rev_ae_edit/'.$itemspara->para_id); ?>><input type="button" name="edit" id="edit" value="Edit" class="btn btn-info pull-right" style="margin:5px; width:80px"></a>
        </div>
     <?php echo form_close( );?>
        </div>
      </div>

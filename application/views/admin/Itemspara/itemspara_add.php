      ...
      <div class="card card-default color-palette-bo">
        ...
        <div class="card-body">   
           <!-- For Messages -->
            ...
            <?php echo form_open(base_url('admin/itemspara/add'), 'class="form-horizontal" enctype="multipart/form-data" ');  ?>  
            ...
            <div class="row">             
                <div class="col-lg-6 col-sm-12">                         
                    <label for="para_text_en" class="control-label" style="padding-top:15px">Para (English) *</label>
                	<textarea id="para_text_en" name="para_text_en"  class="form-control form-group" ></textarea>
                </div>
				   <div class="col-lg-6 col-sm-12">                         
                    <label for="para_text_ur" class="col-sm-12 control-label urdufont-right" style="text-align:right;"> پیرا گراف  ( اردو) *</label>

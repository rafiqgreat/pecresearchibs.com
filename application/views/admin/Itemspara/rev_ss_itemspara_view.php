    ...
    <section class="content">
      <div class="card card-default color-palette-bo">
	   ...
	   <?php 
			...
			$status_pi_21 = (isset($status_pi_21)&&!empty($status_pi_21))?$status_pi_21[0]->item_rev_ss_status:0;
			$status_pi_22 = (isset($status_pi_22)&&!empty($status_pi_22))?$status_pi_22[0]->item_rev_ss_status:0;
			$status_pi_23 = (isset($status_pi_23)&&!empty($status_pi_23))?$status_pi_23[0]->item_rev_ss_status:0;
			$status_pi_24 = (isset($status_pi_24)&&!empty($status_pi_24))?$status_pi_24[0]->item_rev_ss_status:0;
			$status_pi_25 = (isset($status_pi_25)&&!empty($status_pi_25))?$status_pi_25[0]->item_rev_ss_status:0;
			$status_pi_26 = (isset($status_pi_26)&&!empty($status_pi_26))?$status_pi_26[0]->item_rev_ss_status:0;
			$status_pi_27 = (isset($status_pi_27)&&!empty($status_pi_27))?$status_pi_27[0]->item_rev_ss_status:0;
			$status_pi_28 = (isset($status_pi_28)&&!empty($status_pi_28))?$status_pi_28[0]->item_rev_ss_status:0;
			$status_pi_29 = (isset($status_pi_29)&&!empty($status_pi_29))?$status_pi_29[0]->item_rev_ss_status:0;
			$status_pi_30 = (isset($status_pi_30)&&!empty($status_pi_30))?$status_pi_30[0]->item_rev_ss_status:0;
...
?>
                    <tr>
                        ...
                        <?php if ($para_item_21->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_ss_view/'.$para_item_21->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_21->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_ss_view_erq_crq/'.$para_item_21->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?>
                        <?php if($this->session->userdata('role_id')==4){?>
                        <?php if ($para_item_21->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_ae_view/'.$para_item_21->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_21->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_ae_view_erq_crq/'.$para_item_21->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?>
                        </td>
                    </tr>
                    <tr>
...
?>
                <tr>
                    ...
                    <?php }?>
                    <?php if($this->session->userdata('role_id')==2){?>
                    <?php if ($para_item_22->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_ss_view/'.$para_item_22->item_id); ?> target="_blank">View Item</a><?php }?>
                    <?php if ($para_item_22->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_ss_view_erq_crq/'.$para_item_22->item_id); ?> target="_blank">View Item</a><?php }?>
                    <?php }?>
                    <?php if($this->session->userdata('role_id')==4){?>
                    <?php if ($para_item_22->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_ae_view/'.$para_item_22->item_id); ?> target="_blank">View Item</a><?php }?>
                    <?php if ($para_item_22->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_ae_view_erq_crq/'.$para_item_22->item_id); ?> target="_blank">View Item</a><?php }?>
                    <?php }?>
                    </td>
                </tr>
                    <tr>
...
?>
                    <tr>
                        ...
                        <?php }?>
                        <?php if($this->session->userdata('role_id')==2){?>
                        <?php if ($para_item_23->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_ss_view/'.$para_item_23->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_23->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_ss_view_erq_crq/'.$para_item_23->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?>
                        <?php if($this->session->userdata('role_id')==4){?>
                        <?php if ($para_item_23->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_ae_view/'.$para_item_23->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_23->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_ae_view_erq_crq/'.$para_item_23->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?>
                        </td>
                    </tr>
                    <tr>
...
?>
                    <tr>
                        ...
                        <?php }?>
                        <?php if($this->session->userdata('role_id')==2){?>
                        <?php if ($para_item_24->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_ss_view/'.$para_item_24->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_24->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_ss_view_erq_crq/'.$para_item_24->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?>
                        <?php if($this->session->userdata('role_id')==4){?>
                        <?php if ($para_item_24->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_ae_view/'.$para_item_24->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_24->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_ae_view_erq_crq/'.$para_item_24->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?></td>
                    </tr>
                    <tr>
...
?>
                    <tr>
                        ...
                        <?php if($this->session->userdata('role_id')==3){?>
                        <?php if ($para_item_25->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_view/'.$para_item_25->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_25->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_view_erq_crq/'.$para_item_25->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?>
                        <?php if($this->session->userdata('role_id')==2){?>
                        <?php if ($para_item_25->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_ss_view/'.$para_item_25->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_25->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_ss_view_erq_crq/'.$para_item_25->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?>
                        <?php if($this->session->userdata('role_id')==4){?>
                        <?php if ($para_item_25->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_ae_view/'.$para_item_25->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_25->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_ae_view_erq_crq/'.$para_item_25->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?></td>
                    </tr>
                    <tr>
...
?>
                    <tr>
                        ...
                        <?php if($this->session->userdata('role_id')==3){?>
                        <?php if ($para_item_26->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_view/'.$para_item_26->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_26->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_view_erq_crq/'.$para_item_26->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?>
                        <?php if($this->session->userdata('role_id')==2){?>
                        <?php if ($para_item_26->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_ss_view/'.$para_item_26->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_26->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_ss_view_erq_crq/'.$para_item_26->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?>
                        <?php if($this->session->userdata('role_id')==4){?>
                        <?php if ($para_item_26->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_ae_view/'.$para_item_26->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_26->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_ae_view_erq_crq/'.$para_item_26->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?></td>
                    </tr>
                    <tr>
...
?>
                    <tr>
                        ...
                        <?php if($this->session->userdata('role_id')==3){?>
						<?php if ($para_item_27->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_view/'.$para_item_27->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_27->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_view_erq_crq/'.$para_item_27->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?>
                        <?php if($this->session->userdata('role_id')==2){?>
                        <?php if ($para_item_27->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_ss_view/'.$para_item_27->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_27->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_ss_view_erq_crq/'.$para_item_27->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?>
                        <?php if($this->session->userdata('role_id')==4){?>
                        <?php if ($para_item_27->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_ae_view/'.$para_item_27->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_27->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_ae_view_erq_crq/'.$para_item_27->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?></td>
                    </tr>
                    <tr>
...
?>
                    <tr>
                        ...
                        <?php if($this->session->userdata('role_id')==3){?>
						<?php if ($para_item_28->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_view/'.$para_item_28->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_28->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_view_erq_crq/'.$para_item_28->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?>
                        <?php if($this->session->userdata('role_id')==2){?>
                        <?php if ($para_item_28->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_ss_view/'.$para_item_28->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_28->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_ss_view_erq_crq/'.$para_item_28->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?>
                        <?php if($this->session->userdata('role_id')==4){?>
                        <?php if ($para_item_28->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_ae_view/'.$para_item_28->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_28->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_ae_view_erq_crq/'.$para_item_28->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?></td>
                    </tr>
                    <tr>
...
?>
                    <tr>
                        ...
                        <?php if($this->session->userdata('role_id')==3){?>
						<?php if ($para_item_29->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_view/'.$para_item_29->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_29->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_view_erq_crq/'.$para_item_29->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?>
                        <?php if($this->session->userdata('role_id')==2){?>
                        <?php if ($para_item_29->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_ss_view/'.$para_item_29->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_29->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_ss_view_erq_crq/'.$para_item_29->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?>
                        <?php if($this->session->userdata('role_id')==4){?>
                        <?php if ($para_item_29->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_ae_view/'.$para_item_29->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_29->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_ae_view_erq_crq/'.$para_item_29->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?></td>
                    </tr>
                    <tr>
...
?>
                    <tr>
                        ...
                        <?php if($this->session->userdata('role_id')==3){?>
						<?php if ($para_item_30->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_view/'.$para_item_30->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_30->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_view_erq_crq/'.$para_item_30->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?>
                        <?php if($this->session->userdata('role_id')==2){?>
                        <?php if ($para_item_30->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_ss_view/'.$para_item_30->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_30->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_ss_view_erq_crq/'.$para_item_30->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?>
                        <?php if($this->session->userdata('role_id')==4){?>
                        <?php if ($para_item_30->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_ae_view/'.$para_item_30->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_30->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_ae_view_erq_crq/'.$para_item_30->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?></td>
                    </tr>
                    <tr>
...
?>               
        ...
        <div class="col-lg-12">
        	<table width="100%" border="1" style="text-align:center; margin-left:05px">
              ...
              <?php if(!empty($ss)){?>
              <tr>
                <td><?php echo ($ss[0]['username']!="")?$ss[0]['username']:"";?>(SS)</td>
              ...
              <?php if(!empty($ae)){?>
              <tr>
                <td><?php echo ($ae[0]['username']!="")?$ae[0]['username']:"";?>(AE)</td>
              ...
              <tr>
                <td><?php echo ($psy[0]['username'])?$psy[0]['username']:"";?>(PSY)</td>
             ...
             <?php if($itemspara->para_rev_ss_comment!=""){?>
              <tr>
                <td><?php echo ($irinfo[0]['username'])?$irinfo[0]['username']:"";?>(IR)</td>
                <td><?php echo $itemspara->para_rev_comment; ?></td>
                <td><?php if($itemspara->para_rev_status==0){echo "Pending";}elseif($itemspara->para_rev_status==1){echo "Under Review";}elseif($itemspara->para_rev_status==2){echo "Accepted";}?></td>
     ...
     <?php echo form_open(base_url('admin/itemspara/rev_ss_submit_for_approval/'.$itemspara->para_id), 'class="form-horizontal" enctype="multipart/form-data" ');  ?>  
    	<div style="padding-top:15px; margin-left:5px">
        	<?php 
			switch($total_items)
			{
				case 2:
				if($status_pi_21 == 2 && $status_pi_22 == 2)
				{
					?>
                    <label for="para_rev_ss_comment" class="col-sm-6 control-label">Reviewer Comments</label>
                    <textarea id="para_rev_ss_comment" name="para_rev_ss_comment" rows="4" cols="55" style="width:100%" ></textarea>
				...
				case 3:
				if($status_pi_21 == 2 && $status_pi_22 == 2 && $status_pi_23 == 2)
				{
					?>
                    <label for="para_rev_ss_comment" class="col-sm-6 control-label">Reviewer Comments</label>
                    <textarea id="para_rev_ss_comment" name="para_rev_ss_comment" rows="4" cols="55" style="width:100%" ></textarea>
				...
				case 4:
				if($status_pi_21 == 2 && $status_pi_22 == 2 && $status_pi_23 == 2 && $status_pi_24 == 2)
				{
					?>
                    <label for="para_rev_ss_comment" class="col-sm-6 control-label">Reviewer Comments</label>
                    <textarea id="para_rev_ss_comment" name="para_rev_ss_comment" rows="4" cols="55" style="width:100%" ></textarea>
				...
				case 5:
				if($status_pi_21 == 2 && $status_pi_22 == 2 && $status_pi_23 == 2 && $status_pi_24 == 2 && $status_pi_25 == 2)
				{
					?>
                    <label for="para_rev_ss_comment" class="col-sm-6 control-label">Reviewer Comments</label>
                    <textarea id="para_rev_ss_comment" name="para_rev_ss_comment" rows="4" cols="55" style="width:100%" ></textarea>
				...
				case 6:
				if($status_pi_21 == 2 && $status_pi_22 == 2 && $status_pi_23 == 2 && $status_pi_24 == 2 && $status_pi_25 == 2 && $status_pi_26 == 2)
				{
					?>
                    <label for="para_rev_ss_comment" class="col-sm-6 control-label">Reviewer Comments</label>
                    <textarea id="para_rev_ss_comment" name="para_rev_ss_comment" rows="4" cols="55" style="width:100%" ></textarea>
				...
				case 7:
				if($status_pi_21 == 2 && $status_pi_22 == 2 && $status_pi_23 == 2 && $status_pi_24 == 2 && $status_pi_25 == 2 && $status_pi_26 == 2 && $status_pi_27 == 2)
				{
					?>
                    <label for="para_rev_ss_comment" class="col-sm-6 control-label">Reviewer Comments</label>
                    <textarea id="para_rev_ss_comment" name="para_rev_ss_comment" rows="4" cols="55" style="width:100%" ></textarea>
				...
				case 8:
				if($status_pi_21 == 2 && $status_pi_22 == 2 && $status_pi_23 == 2 && $status_pi_24 == 2 && $status_pi_25 == 2 && $status_pi_26 == 2 && $status_pi_27 == 2 && $status_pi_28 == 2)
				{
					?>
                    <label for="para_rev_ss_comment" class="col-sm-6 control-label">Reviewer Comments</label>
                    <textarea id="para_rev_ss_comment" name="para_rev_ss_comment" rows="4" cols="55" style="width:100%" ></textarea>
				...
				case 9:
				if($status_pi_21 == 2 && $status_pi_22 == 2 && $status_pi_23 == 2 && $status_pi_24 == 2 && $status_pi_25 == 2 && $status_pi_26 == 2 && $status_pi_27 == 2 && $status_pi_28 == 2 && $status_pi_29 == 2)
				{
					?>
                    <label for="para_rev_ss_comment" class="col-sm-6 control-label">Reviewer Comments</label>
                    <textarea id="para_rev_ss_comment" name="para_rev_ss_comment" rows="4" cols="55" style="width:100%" ></textarea>
				...
				case 10:
				if($status_pi_21 == 2 && $status_pi_22 == 2 && $status_pi_23 == 2 && $status_pi_24 == 2 && $status_pi_25 == 2 && $status_pi_26 == 2 && $status_pi_27 == 2 && $status_pi_28 == 2 && $status_pi_29 == 2 && $status_pi_30 == 2)
				{
					?>
                    <label for="para_rev_ss_comment" class="col-sm-6 control-label">Reviewer Comments</label>
                    <textarea id="para_rev_ss_comment" name="para_rev_ss_comment" rows="4" cols="55" style="width:100%" ></textarea>
			 ...
			 ?>
            <a href=<?php echo base_url('admin/itemspara/rev_ss_edit/'.$itemspara->para_id); ?>><input type="button" name="edit" id="edit" value="Edit" class="btn btn-info pull-right" style="margin:5px; width:80px"></a>
        </div>
     <?php echo form_close( );?>
        </div>
      </div>

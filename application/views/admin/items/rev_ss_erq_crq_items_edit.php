      ...
      <div class="card card-default color-palette-bo">
        ...
        <div class="card-body">   
           <!-- For Messages -->
            ...
            <?php echo form_open(base_url('admin/items/rev_ss_edit_erq_crq/'.$item['item_id']), 'class="form-horizontal" enctype="multipart/form-data" ');  ?>  
            ...
            <div class="row">             
              ...
              <div class="form-group row">
                 ...
                 <div class="col-lg-3 col-sm-12"><?php if ($item['item_rubric_image']!=""){?><img src="<?php echo base_url().$item['item_rubric_image'];?>" style="max-height:100px; max-width:100px;"/><a class="delete btn btn-sm btn-danger" style="padding-left:10px" href='<?php echo base_url("admin/items/rev_delete_item_rubric_image/". $item['item_id']); ?>' title="Delete" onclick="return confirm(\'Do you want to delete ?\')"><i class="fa fa-trash-o"></i></a><?php }?></div>
              </div> 
              <?php }?>  
              <div class="form-group">
                <div class="col-md-12">
                  <?php if($this->session->userdata('role_id')==2){?><input type="submit" name="submit" value="Update" class="btn btn-info pull-right"><?php }?>
                </div>
              </div>
            <?php echo form_close( ); ?>
          <!-- /.box-body -->

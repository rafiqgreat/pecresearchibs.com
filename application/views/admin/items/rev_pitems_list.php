...
<script>
  ...
  var table = $('#na_datatable').DataTable( {
    ...
    "ajax": "<?=base_url('admin/items/datatable_jsonp_rev');?>",
    "columnDefs": [
    	{ "targets": 0, "name": "item_id", 'searchable':false, 'orderable':false},
    	{ "targets": 1, "name": "lastname", 'searchable':false, 'orderable':true},
    	...
    	{ "targets": 5, "name": "grade_code", 'searchable':false, 'orderable':true},

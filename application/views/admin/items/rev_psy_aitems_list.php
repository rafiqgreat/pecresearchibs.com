...
<div class="content-wrapper">
  <section class="content">
    ...
    <div class="card">
      <div class="card-header">
        <div class="d-inline-block">
          <h3 class="card-title"><i class="fa fa-list"></i>&nbsp; Psychometrician Accepted Items List</h3>
        </div>
    ...
    <div class="card">
      <div class="card-header">
            <?php echo form_open(base_url('admin/items/rev_psy_aitems_search'), 'class="form-horizontal" method="post" onSubmit="return checkFields();" ');  ?>
...
<script>
  ...
  var table = $('#na_datatable').DataTable( {
    ...
    "ajax": "<?=base_url('admin/items/datatable_jsona_rev_psy');?>",
  //  "order": [[1,'desc']],
    "columnDefs": [

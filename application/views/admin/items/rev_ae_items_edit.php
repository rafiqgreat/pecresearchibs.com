    ...
    <section class="content">
      <div class="card card-default color-palette-bo">
        <div class="card-header">
          ...
          <?php if($item['item_rev_ae_status']==0){ ?>
            <a href="<?= base_url('admin/items/rev_ae_pitems'); ?>" class="btn btn-success"><i class="fa fa-list"></i>  Items List</a>
          <?php } elseif($item['item_rev_ae_status']==1){ ?>  
          <a href="<?= base_url('admin/items/rev_ae_eitems'); ?>" class="btn btn-success"><i class="fa fa-list"></i>  Items List</a>
          <?php }?>
          </div>
        </div>
        <div class="card-body">   
           <!-- For Messages -->
            ...
            <?php echo form_open(base_url('admin/items/rev_ae_edit/'.$item['item_id']), 'class="form-horizontal" enctype="multipart/form-data" ');  ?>  
			...
			<div class="row">             
              ...
              <div class="form-group">
                <div class="col-md-12">
                  <?php if($this->session->userdata('role_id')==4){?><input type="submit" name="submit" value="Update" class="btn btn-info pull-right"><?php }?>
                </div>
              </div>
            <?php echo form_close( ); ?>
          <!-- /.box-body -->

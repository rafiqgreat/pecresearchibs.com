      ...
      <div class="card card-default color-palette-bo">
        ...
        <div class="card-body">   
           <!-- For Messages -->
            ...
            <?php echo form_open(base_url('admin/items/edit/'.$item['item_id']), 'class="form-horizontal" enctype="multipart/form-data" ');  ?>  
			...
			<div class="row">
              	<div class="col-lg-3 col-sm-12">                         
                    ...
                    <div class="col-12">
                      <input type="date" name="item_date_received" class="form-control" id="item_date_received" placeholder="" required="required" value="<?php $item['item_date_received']; ?>" >
                    </div>
                </div>
				<div class="col-lg-3 col-sm-12">                         
                    <label for="item_code" class="col-sm-6 control-label">Item Code *</label>
                    <div class="col-12">
                      <input type="text" name="item_code" class="form-control" id="item_code" placeholder="" required="required"  value="<?= $item['item_code']; ?>">
                    </div>
                </div>
                      ...
                      foreach($slos as $slo)
                          {
                            $selectedText = '';
							  ...
							  $selectedText = ' selected="selected" ';
                            	echo '<option value="'.$slo['slo_id'].'" '.$selectedText.'>'.$slo['slo_statement_en'].'</option>';
                          }
						?>
                    </select>
                </div>
			...
			<div class="row">
				...
				<div class="col-lg-2 col-sm-12">  
					...
					<input type="text" name="item_pctb_chapter" class="form-control" id="item_pctb_chapter" placeholder=""  value="<?= $item['item_pctb_chapter']; ?>">                   
                </div>
				<div class="col-lg-2 col-sm-12">  
					<label for="item_pctb_page" class="control-label">PCTB Page No.</label>
					<input type="text" name="item_pctb_page" class="form-control" id="item_pctb_page" placeholder=""  value="<?= $item['item_pctb_page']; ?>">                   
                </div>
				<div class="col-lg-2 col-sm-12">  
					<label for="item_other_title" class="control-label">Other Title</label>
					<input type="text" name="item_other_title" class="form-control" id="item_other_title" placeholder=""  value="<?= $item['item_other_title']; ?>">                   
                </div>
				<div class="col-lg-2 col-sm-12">  
					<label for="item_other_year" class="control-label">Other Year</label>
					<input type="text" name="item_other_year" class="form-control" id="item_other_year" placeholder=""  value="<?= $item['item_other_year']; ?>">                   
                </div>
				<div class="col-lg-2 col-sm-12">  
					<label for="item_other_page" class="control-label">Other Page No.</label>
					<input type="text" name="item_other_page" class="form-control" id="item_other_page" placeholder=""  value="<?= $item['item_other_page']; ?>">                   
                </div>				
              </div>
			<div class="row">
			...
			<div class="row">             
				 <div class="col-lg-2 col-sm-12">                         
                    <label for="item_image_position" class="control-label">Stem Images Potion</label>
              ...
              <div class="row">             
                ...
                <div class="col-lg-5 col-sm-12"><?php if($item['item_image_en']!=""){?><img src="<?php echo base_url().$item['item_image_en'];?>" style="max-height:200px; max-width:200px;"/><?php }?></div>
                <div class="col-lg-5 col-sm-12"><?php if($item['item_image_ur']!=""){?><img src="<?php echo base_url().$item['item_image_ur'];?>" style="max-height:200px; max-width:200px;"/><?php }?></div>    
              </div>
              <?php }?>
			<div class="row">             
                <div class="col-lg-12 col-sm-12">                         
			...
			<div class="row">             
                <div class="col-lg-6 col-sm-12">                         
                	...
                	<input type="text" name="item_option_a_en" class="form-control" id="item_option_a_en" placeholder=""  value="<?= $item['item_option_a_en']; ?>" >
                </div>
				<div class="col-lg-6 col-sm-12">                         
                    <label for="item_option_a_ur" class="control-label urdufont-right" style="text-align:right; float: right" lang="ur" dir="rtl"> آپشن اے  اردو </label>
                	<input type="text" name="item_option_a_ur" class="form-control" id="item_option_a_ur" placeholder=""  value="<?= $item['item_option_a_ur']; ?>" dir="rtl" lang="ur" >
                </div>				
              </div>
			<div class="row">             
                <div class="col-lg-6 col-sm-12">                         
                    <label for="item_option_b_en" class="control-label">Option b (English)</label>
                	<input type="text" name="item_option_b_en" class="form-control" id="item_option_b_en" placeholder=""  value="<?= $item['item_option_b_en']; ?>" >
                </div>
				<div class="col-lg-6 col-sm-12">                         
                    <label for="item_option_b_ur" class="control-label urdufont-right" style="text-align:right; float: right" lang="ur" dir="rtl"> آپشن بی  اردو </label>
                	<input type="text" name="item_option_b_ur" class="form-control" id="item_option_b_ur" placeholder=""  value="<?= $item['item_option_b_ur']; ?>" dir="rtl" lang="ur" >
                </div>
              </div>
			<div class="row">             
                <div class="col-lg-6 col-sm-12">                         
                    <label for="item_option_c_en" class="control-label">Option c (English)</label>
                	<input type="text" name="item_option_c_en" class="form-control" id="item_option_c_en" placeholder=""  value="<?= $item['item_option_c_en']; ?>" >
                </div>
				<div class="col-lg-6 col-sm-12">                         
                    <label for="item_option_c_ur" class="control-label urdufont-right" style="text-align:right; float: right" lang="ur" dir="rtl"> آپشن سی  اردو </label>
                	<input type="text" name="item_option_c_ur" class="form-control" id="item_option_c_ur" placeholder=""  value="<?= $item['item_option_c_ur']; ?>"  dir="rtl" lang="ur"  >
                </div>
              </div>
			<div class="row">             
                <div class="col-lg-6 col-sm-12">                         
                    <label for="item_option_d_en" class="control-label">Option d (English)</label>
                	<input type="text" name="item_option_d_en" class="form-control" id="item_option_d_en" placeholder=""  value="<?= $item['item_option_d_en']; ?>" >
                </div>
				<div class="col-lg-6 col-sm-12">                         
                    <label for="item_option_d_ur" class="control-label urdufont-right" style="text-align:right; float: right" lang="ur" dir="rtl"> آپشن ڈی  اردو </label>
                	<input type="text" name="item_option_d_ur" class="form-control" id="item_option_d_ur" placeholder=""  value="<?= $item['item_option_d_ur']; ?>"  dir="rtl" lang="ur" >
                </div>
              </div>
              ...
              <div class="form-group row">
                 <div class="col-lg-3 col-sm-12"><?php if ($item['item_option_a_image']!=""){?><img src="<?php echo base_url().$item['item_option_a_image'];?>" style="max-height:200px; max-width:200px;"/><?php }?></div>
				 <div class="col-lg-3 col-sm-12"><?php if ($item['item_option_b_image']!=""){?><img src="<?php echo base_url().$item['item_option_b_image'];?>" style="max-height:200px; max-width:200px;"/><?php }?></div>
                 <div class="col-lg-3 col-sm-12"><?php if ($item['item_option_c_image']!=""){?><img src="<?php echo base_url().$item['item_option_c_image'];?>" style="max-height:200px; max-width:200px;"/><?php }?></div>
                 <div class="col-lg-3 col-sm-12"><?php if ($item['item_option_d_image']!=""){?><img src="<?php echo base_url().$item['item_option_d_image'];?>" style="max-height:200px; max-width:200px;"/><?php }?></div>
              </div> 
              <?php }?>            

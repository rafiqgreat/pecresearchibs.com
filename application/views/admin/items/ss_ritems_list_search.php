    ...
    <div class="card">
      <div class="card-header">
        <div class="d-inline-block">
          <h3 class="card-title"><i class="fa fa-list"></i>&nbsp; Rejected Items List (Submitted by Item Writers )</h3>
        </div>
...
?>
  ...
  var table = $('#na_datatable').DataTable( {
    "processing": true,
    "serverSide": true,
    "ajax": "<?=base_url('admin/items/datatable_json_ss_rejected/'.$param1.'_'.$param2.'_'.$param3.'_'.$param4);?>",
  //  "order": [[1,'desc']],
    "columnDefs": [

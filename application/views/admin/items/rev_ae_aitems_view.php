        ...
        <div class="col-lg-12">
        	<table width="100%" border="1" style="text-align:center; margin-left:05px">
              ...
              <tr>
                ...
                <td><?php if($item->item_rev_status==2){echo "Accepted";}elseif($item->item_rev_status==1){echo "Under Review";}elseif($item->item_rev_status==0){echo "Pending";}?></td>
                <td><?php echo date("d-M-Y (h:i a)",strtotime($item->item_rev_date_acc));?></td>
              </tr>
              <?php }?>
              <?php if($item->item_rev_ss_comment!=""){?>
              <tr>
                <td><?php echo (isset($ss[0]['username'])&&$ss[0]['username']!="")?$ss[0]['username']:"";?>(SS)</td>
                <td><?php echo $item->item_rev_ss_comment; ?></td>
                <td><?php if($item->item_rev_ss_status==2){echo "Accepted";}elseif($item->item_rev_ss_status==1){echo "Under Review";}elseif($item->item_rev_ss_status==0){echo "Pending";}?></td>
                <td><?php echo date("d-M-Y (h:i a)",strtotime($item->item_rev_ss_date_acc));?></td>
              </tr>
              <?php }?>
              <?php if($item->item_rev_ae_comment!=""){?>
              <tr>
                <td><?php echo (isset($ae[0]['username'])&&$ae[0]['username']!="")?$ae[0]['username']:"";?>(AE)</td>
                <td><?php echo $item->item_rev_ae_comment; ?></td>
                <td><?php if($item->item_rev_ae_status==2){echo "Accepted";}elseif($item->item_rev_ae_status==1){echo "Under Review";}elseif($item->item_rev_ae_status==0){echo "Pending";}?></td>
                <td><?php echo date("d-M-Y (h:i a)",strtotime($item->item_rev_ae_date_acc));?></td>
              </tr>
              <?php }?>
            </table>
        </div>
...
<a href=<?php echo base_url('admin/items/rev_edit/'.$item->item_id); ?>><input type="button" name="edit" id="edit" value="Edit Item" class="btn btn-info pull-right" style="margin:10px;"></a>
<?php echo form_close( ); */?>
</div>

      ...
      <div class="card-header">
        ...
        <div class="d-inline-block float-right">
          <div class="btn-group margin-bottom-20"> 
            <a href="<?= base_url() ?>admin/items/create_sitems_pdf" class="btn btn-secondary">Export as PDF</a>
...
<script>
  ...
  var table = $('#na_datatable').DataTable( {
    "processing": true,
    "serverSide": true,
    "ajax": "<?=base_url('admin/items/datatable_jsons'.((isset($item_subject_id)&&$item_subject_id!="")?'/'.$item_subject_id:''));?>",
  //  "order": [[1,'desc']],
    "columnDefs": [

...
?>               
    ...
    <div class="row col-lg-12">
        ...
        <div class="col-lg-12">
            ...
            <?php } elseif($item->item_status==3 || $item->item_status==4){ ?>
        ...
        <textarea id="item_comment_ss" name="item_comment_ss" rows="2" cols="55" style="width:100%" required="required" readonly="readonly"><?php echo $item->item_comment_ss; ?></textarea>
            ...
            <div style="padding:10px 0px 10px 4px;">
                <label for="item_comment_ss" class="col-sm-6 control-label">Assessment Expert <?php if(!empty($aeinfo)){echo '('.$aeinfo['firstname'].' '.$aeinfo['lastname'].')';}?> Comments <?php if($item->item_status_ae ==1){ echo '(Approved)'; } elseif($item->item_status_ae ==2){ echo '(Rejected)'; } ?> on <?php echo date("d-M-Y (h:i a)",strtotime($item->item_reviewed));?></label>
                <textarea id="item_comment_ss" name="item_comment_ss" rows="2" cols="55" style="width:100%" required="required" readonly="readonly"><?php echo $item->item_comment_ae; ?></textarea>
            </div><?php }?>

      ...
      <div class="card card-default color-palette-bo">
        <div class="card-header">
          ...
          <div class="d-inline-block float-right">
            <a href="<?= base_url('admin/items/psy_items'); ?>" class="btn btn-success"><i class="fa fa-list"></i> Items List</a>
          </div>
        </div>
        <div class="card-body">   
           <!-- For Messages -->
    ...
    <div style="padding:10px 0px 10px 4px;">
	  ...
	  <?php echo form_open(base_url('admin/items/psy_submit_for_approval/'.$item->item_id), 'class="form-horizontal" enctype="multipart/form-data" ');  ?>  
    	<div style="padding-top:15px; margin-left:5px">
            ...
            <input type="submit" name="submit_psy" id="submit_psy" value="Review Item" class="btn btn-success pull-right" style="margin:5px">
		</div>

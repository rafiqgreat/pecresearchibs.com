    ...
    <?php if($item->item_status_ss==0){?>
     <?php echo form_open(base_url('admin/items/ss_submit_for_approval/'.$item->item_id), 'class="form-horizontal" enctype="multipart/form-data" ');  ?>  
    	<div style="padding-top:15px; margin-left:5px">
            ...
            <a href=<?php if($item->item_type=='MCQ'){echo base_url('admin/items/edit/'.$item->item_id);} else {echo base_url('admin/items/edit_erq_crq/'.$item->item_id);}?>><input type="button" name="edit" id="edit" value="Edit Item" class="btn btn-info pull-right" style="margin:5px"></a>
        </div>

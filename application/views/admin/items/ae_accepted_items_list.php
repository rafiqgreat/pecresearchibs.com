...
<div class="content-wrapper">
  <section class="content">
    ...
    <div class="card">
      <div class="card-header">
        <div class="d-inline-block">
          <h3 class="card-title"><i class="fa fa-list"></i>&nbsp; Accepted Items List (Approved by SS)</h3>
        </div>
    ...
    <div class="card">
      <div class="card-header">
        	<?php echo form_open(base_url('admin/items/ae_aitems_search'), 'class="form-horizontal" method="post" onSubmit="return checkFields();" ');  ?>
            <div class="row">
...
<script>
  ...
  var table = $('#na_datatable').DataTable( {
    "processing": true,
    "serverSide": true,
    "ajax": "<?=base_url('admin/items/datatable_jsons_ae_accepted'.((isset($item_subject_id)&&$item_subject_id!="")?'/'.$item_subject_id:''));?>",
  //  "order": [[1,'desc']],
    "columnDefs": [

...
//$param4 = (isset($item_type)&&$item_type!="")?$item_type:0;
//echo $search_grade;
    ...
    <div class="card">
      <div class="card-header">
        <div class="d-inline-block">
          <h3 class="card-title"><i class="fa fa-list"></i>&nbsp; Pending Items List (Submitted by Item Writers )</h3>
        </div>
...
?>
  ...
  var table = $('#na_datatable').DataTable( {
    "processing": true,
    "serverSide": true,
    "ajax": "<?=base_url('admin/items/datatable_jsonssp/'.$param1.'_'.$param2.'_'.$param3.'_'.$param4);?>",
  //  "order": [[1,'desc']],
    "columnDefs": [

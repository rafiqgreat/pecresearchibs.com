        ...
        <li id="profile" class="nav-item has-treeview">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
			  ...
			  <li class="nav-item">
              <a href="<?= base_url('admin/profile/change_pwd_school'); ?>" class="nav-link">
                <i class="fa fa-circle-o nav-icon"></i>
...
<?php endif; ?>
<?php if(in_array('role_private_school',$this->session->userdata('role_permissions'))): ?>	
<li id="schools" class="nav-item">
   <a href="<?= base_url('admin/school/add_private'); ?>" class="nav-link">
            <i class="nav-icon fa fa-edit"></i>
            <p>
              Register Private School
            </p>
          </a>
</li>  
<?php endif; ?> 

        ...
        <div class="card-body">   
           <!-- For Messages -->
            ...
            <?php echo form_open(base_url('admin/slos/edit/'.$slos['slo_id']), 'class="form-horizontal"');  ?> 
              ...
              <div class="col-6">
                <label for="slo_cstand_id" class="col-sm-6 control-label">Content Stand</label>
               ...
               <div class="form-group">                         
                <div class="col-12">
                <label for="slo_subcstand_id" class="col-sm-6 control-label">Sub Content Stand</label>
                <select name="slo_subcstand_id" class="form-control" id="slo_subcstand_id"  required>
                  <option value="">--Select Sub Content Stand--</option>   
                  <?php

      ...
      <div class="card card-default color-palette-bo">
        ...
        <div class="card-body">   
           <!-- For Messages -->
            ...
            <?php echo form_open(base_url('admin/itemsgroup/rev_edit/'.$group->group_id), 'class="form-horizontal" enctype="multipart/form-data" onsubmit="return checkItems();"');  ?>  
			...
			<div class="row">              
             ...
             <div class="col-lg-12 col-sm-12">                         
              ...
              <div class="form-group">
                <div class="col-md-12">
                    <label for="group_comment_ss" class="col-sm-6 control-label">Comments</label>

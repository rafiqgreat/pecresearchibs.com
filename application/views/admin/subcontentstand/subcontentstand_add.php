      ...
      <div class="card card-default color-palette-bo">
        <div class="card-header">
          <div class="d-inline-block">
              ...
              Add New SubContent Stand</h3>
          </div>
          <div class="d-inline-block float-right">
            <a href="<?= base_url('admin/subcontentstand'); ?>" class="btn btn-success"><i class="fa fa-list"></i>  SubContent Stand List</a>
          </div>
        </div>
        <div class="card-body">   
           <!-- For Messages -->
            ...
            <?php echo form_open(base_url('admin/subcontentstand/add'), 'class="form-horizontal"');  ?> 
              <div class="row">
                ...
                <div class="col-lg-4 col-sm-12">
                <label for="subcs_cstand_id" class="control-label">Content Stand</label>
              ...
              <div class="row">
                <div class="col-lg-6 col-sm-12">
                    <label for="subcs_number" class=" control-label">SubContent Stand No.</label>
                    <input type="text" name="subcs_number" class="form-control form-group" id="subcs_number" placeholder="" required="required">
                </div>
                <div class="col-lg-6 col-sm-12">
                    <label for="subcs_sort" class="control-label">SubContent Stand Sort</label>
              ...
              <div class="form-group">
                <div class="col-md-12">
                  <input type="submit" name="submit" value="Add SubContent Stand" class="btn btn-info pull-right">
                </div>
              </div>
            <?php echo form_close( ); ?>
          <!-- /.box-body -->

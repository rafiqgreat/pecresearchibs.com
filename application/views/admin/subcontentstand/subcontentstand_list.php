    ...
    <div class="card">
      <div class="card-header">
        <div class="d-inline-block">
          <h3 class="card-title"><i class="fa fa-list"></i>&nbsp; SubContent Stand List</h3>
        </div>
        <div class="d-inline-block float-right">
          ...
          <a href="<?= base_url('admin/subcontentstand/add'); ?>" class="btn btn-success"><i class="fa fa-plus"></i> Add New SubContent Stand</a>
        </div>
      </div>
    </div>
...
<script>
  ...
  //  "order": [[1,'desc']],
    "columnDefs": [
	  ...
	  { "targets": 8, "name": "subcs_status", 'searchable':false, 'orderable':false,'width':'100px'},
...
<script type="text/javascript">
  $("body").on("change",".tgl_checkbox",function(){
    ...
    function(data){
      $.notify("SubContent Stand Status Changed Successfully", "success");
    });
  });
</script>

...
<?php } ?>
      ...
      <div class="row" style="padding-top:20px">
        <div class="col-lg-12">
        	<table width="100%" border="1" style="text-align:center; margin-left:05px">
              ...
              <tr>
                <td><?php (isset($ss[0]['username'])&&$ss[0]['username']!="")?$ss[0]['username']:"";?>(SS)</td>
              ...
              <tr>
                <td><?php (isset($ae[0]['username'])&&$ae[0]['username']!="")?$ae[0]['username']:"";?>(AE)</td>
     ...
     <?php echo form_open(base_url('admin/itemsgroup/rev_ae_submit_for_approval/'.$groupinfo->group_id), 'class="form-horizontal" enctype="multipart/form-data" ');  ?>  
    	<div style="padding-top:15px; margin-left:5px">
            <label for="group_rev_ae_comment" class="col-sm-6 control-label">Reviewer Comments</label>
            <textarea id="group_rev_ae_comment" name="group_rev_ae_comment" rows="4" cols="55" style="width:100%" required="required"></textarea>
            <input type="submit" name="submit" id="submit" value="Accept" class="btn btn-success pull-right" style="margin:5px; width:80px">
            <a href=<?php echo base_url('admin/itemsgroup/rev_ae_edit/'.$groupinfo->group_id); ?>><input type="button" name="edit" id="edit" value="Edit" class="btn btn-info pull-right" style="margin:5px; width:80px"></a>
        </div>
     <?php echo form_close( );?>
        </div>
      </div>

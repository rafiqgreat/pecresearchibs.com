    ...
    <section class="content">
      <div class="card card-default color-palette-bo">
	   ...
	   <?php 
			...
			$status_gi_1 = (isset($status_gi_1)&&!empty($status_gi_1))?$status_gi_1[0]->item_rev_status:0;//$status_gi_1[0]->item_rev_status;
			$status_gi_2 = (isset($status_gi_2)&&!empty($status_gi_2))?$status_gi_2[0]->item_rev_status:0;
			$status_gi_3 = (isset($status_gi_3)&&!empty($status_gi_3))?$status_gi_3[0]->item_rev_status:0;
			$status_gi_4 = (isset($status_gi_4)&&!empty($status_gi_4))?$status_gi_4[0]->item_rev_status:0;
			$status_gi_5 = (isset($status_gi_5)&&!empty($status_gi_5))?$status_gi_5[0]->item_rev_status:0;
			$status_gi_6 = (isset($status_gi_6)&&!empty($status_gi_6))?$status_gi_6[0]->item_rev_status:0;
			$status_gi_7 = (isset($status_gi_7)&&!empty($status_gi_7))?$status_gi_7[0]->item_rev_status:0;
			$status_gi_8 = (isset($status_gi_8)&&!empty($status_gi_8))?$status_gi_8[0]->item_rev_status:0;
			$status_gi_9 = (isset($status_gi_9)&&!empty($status_gi_9))?$status_gi_9[0]->item_rev_status:0;
			$status_gi_10 = (isset($status_gi_10)&&!empty($status_gi_10))?$status_gi_10[0]->item_rev_status:0;
...
<?php } ?>
     ...
     <?php echo form_open(base_url('admin/itemsgroup/rev_submit_for_approval/'.$groupinfo->group_id), 'class="form-horizontal" enctype="multipart/form-data" ');  ?>  
    	<div style="padding-top:15px; margin-left:5px">
			...
			switch($total_items)
			{
				...
				{
					?>
                    <label for="group_rev_comment" class="col-sm-6 control-label">Reviewer Comments</label>
                    <textarea id="group_rev_comment" name="group_rev_comment" rows="4" cols="55" style="width:100%" ></textarea>
            ...
            <a href=<?php echo base_url('admin/itemsgroup/rev_edit/'.$groupinfo->group_id); ?>><input type="button" name="edit" id="edit" value="Edit" class="btn btn-info pull-right" style="margin:5px; width:80px"></a>
        </div>
     <?php echo form_close( );?>
        </div>
      </div>

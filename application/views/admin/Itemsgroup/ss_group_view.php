      ...
      <div class="card card-default color-palette-bo">
	   ...
	   <?php 
			...
			?>
                ...
                <?php if ($group_item_1->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/ae_view_erq_crq/'.$group_item_1->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?></td></tr>
                <?php }?>
  ...
  <tr>
    ...
    <td><span class="urdufont-right" style="padding-left:20px"><?php echo html_entity_decode($group_item_1->item_option_d_ur);?></span></td>
			...
			?>
                ...
                <?php if ($group_item_2->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/ae_view_erq_crq/'.$group_item_2->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?></td></tr>
                <?php }?>
...
?>
			...
			?>
                ...
                <?php if ($group_item_3->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/ae_view_erq_crq/'.$group_item_3->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?></td></tr>
                <?php }?>
...
<?php } ?>
			...
			?>
                ...
                <?php if ($group_item_4->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/ae_view_erq_crq/'.$group_item_4->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?></td></tr>
                <?php }?>
...
<?php } ?>
			...
			?>
                ...
                <?php if ($group_item_5->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/ae_view_erq_crq/'.$group_item_5->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?></td></tr>
                <?php }?>
...
<?php } ?>
			...
			?>
                ...
                <?php if ($group_item_6->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/ae_view_erq_crq/'.$group_item_6->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?></td></tr>
                <?php }?>
...
<?php } ?>
			...
			?>
                ...
                <?php if ($group_item_7->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/ae_view_erq_crq/'.$group_item_7->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?></td></tr>
                <?php }?>
...
<?php } ?>
			...
			?>
                ...
                <?php if ($group_item_8->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/ae_view_erq_crq/'.$group_item_8->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?></td></tr>
                <?php }?>
...
<?php } ?>
			...
			?>
                ...
                <?php if ($group_item_9->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/ae_view_erq_crq/'.$group_item_9->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?></td></tr>
                <?php }?>
...
<?php } ?>
			...
			?>
                ...
                <?php if ($group_item_10->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/ae_view_erq_crq/'.$group_item_10->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?></td></tr>
                <?php }?>
...
<?php } ?>
     ...
     <?php if($groupinfo->group_status_ss==0){?>
     <?php echo form_open(base_url('admin/itemsgroup/ss_submit_for_approval/'.$groupinfo->group_id), 'class="form-horizontal" enctype="multipart/form-data" ');  ?>  
    	<div style="padding-top:15px; margin-left:5px">
            <label for="group_comment_ss" class="col-sm-6 control-label">SS Comments</label>
            <textarea id="group_comment_ss" name="group_comment_ss" rows="4" cols="55" style="width:100%" ></textarea>
            <input type="submit" name="submit_awoc" id="submit_awoc" value="Accept Item" class="btn btn-success pull-right" style="margin:5px">
            <input type="submit" name="reject_ss" id="reject_ss" value="Reject Item" class="btn btn-danger pull-right" style="margin:5px">
            <a href=<?php echo base_url('admin/itemsgroup/edit/'.$groupinfo->group_id); ?>><input type="button" name="edit" id="edit" value="Edit Item" class="btn btn-info pull-right" style="margin:5px"></a>
        </div>
     <?php echo form_close( );} else { ?> 
      	<div style="padding-top:15px; margin-left:5px">
            <label for="" class="col-sm-12 control-label">Subject Specialist Comments <?php if($groupinfo->group_status_ss ==1){ echo '(Rejected)'; } elseif($groupinfo->group_status_ss ==2){ echo '(Accepted with Change)'; }elseif($groupinfo->group_status_ss ==3){ echo '(Accepted without change)'; } ?> on <?php echo $groupinfo->group_approved;?></label>
        <textarea id="" name="" rows="2" cols="55" style="width:100%" required="required" readonly="readonly"><?php echo $groupinfo->group_comment_ss; ?></textarea>
        </div>
        <?php if($groupinfo->group_comment_ae !=""){?>
        <div style="padding:10px 0px 10px 4px;">
                <label for="" class="col-sm-6 control-label">Assessment Expert Comments <?php if($groupinfo->group_status_ae ==1){ echo '(Approved)'; } elseif($groupinfo->group_status_ae ==2){ echo '(Rejected)'; } ?> on <?php echo $groupinfo->group_reviewed;?></label>
                <textarea id="" name="" rows="2" cols="55" style="width:100%" required="required" readonly="readonly"><?php echo $groupinfo->group_comment_ae; ?></textarea>
            </div>
        <?php }?>
        <?php if($groupinfo->group_comment_psy !=""){?>
            <div style="padding:10px 0px 10px 4px;">
                <label for="" class="col-sm-6 control-label">Psychometrician Comments <?php if($groupinfo->group_status_psy ==1){ echo '(Reviewed)'; } elseif($groupinfo->group_status_psy ==2){ echo '(Rejected)'; } ?> on <?php echo $groupinfo->group_date_psy;?></label>

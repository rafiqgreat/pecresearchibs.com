...
?>
            ...
            <div style="padding:15px 0px; float:right"><a href="<?= base_url('admin/Itemsgroup/submitgroup_for_approval/'.$groupinfo->group_id); ?>" class="btn btn-success"> Submit For Approval</a></div>
            <?php }?>
        </div>
      </div>
    </section> 

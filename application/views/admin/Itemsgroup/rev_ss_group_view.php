    ...
    <section class="content">
      <div class="card card-default color-palette-bo">
	   ...
	   <?php 
			...
			$total_items = 0;
			if($groupinfo->group_item_1!=0) $total_items++;
			if($groupinfo->group_item_2!=0) $total_items++;
			if($groupinfo->group_item_3!=0) $total_items++;
			if($groupinfo->group_item_4!=0) $total_items++;
			if($groupinfo->group_item_5!=0) $total_items++;
			if($groupinfo->group_item_6!=0) $total_items++;
			if($groupinfo->group_item_7!=0) $total_items++;
			if($groupinfo->group_item_8!=0) $total_items++;
			if($groupinfo->group_item_9!=0) $total_items++;
			if($groupinfo->group_item_10!=0) $total_items++;
			
			$status_gi_1 = (isset($status_gi_1)&&!empty($status_gi_1))?$status_gi_1[0]->item_rev_ss_status:0;
			$status_gi_2 = (isset($status_gi_2)&&!empty($status_gi_2))?$status_gi_2[0]->item_rev_ss_status:0;
			$status_gi_3 = (isset($status_gi_3)&&!empty($status_gi_3))?$status_gi_3[0]->item_rev_ss_status:0;
			$status_gi_4 = (isset($status_gi_4)&&!empty($status_gi_4))?$status_gi_4[0]->item_rev_ss_status:0;
			$status_gi_5 = (isset($status_gi_5)&&!empty($status_gi_5))?$status_gi_5[0]->item_rev_ss_status:0;
			$status_gi_6 = (isset($status_gi_6)&&!empty($status_gi_6))?$status_gi_6[0]->item_rev_ss_status:0;
			$status_gi_7 = (isset($status_gi_7)&&!empty($status_gi_7))?$status_gi_7[0]->item_rev_ss_status:0;
			$status_gi_8 = (isset($status_gi_8)&&!empty($status_gi_8))?$status_gi_8[0]->item_rev_ss_status:0;
			$status_gi_9 = (isset($status_gi_9)&&!empty($status_gi_9))?$status_gi_9[0]->item_rev_ss_status:0;
			$status_gi_10 = (isset($status_gi_10)&&!empty($status_gi_10))?$status_gi_10[0]->item_rev_ss_status:0;
			...
			?>
				...
				<?php if ($group_item_1->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_view/'.$group_item_1->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php if ($group_item_1->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_view_erq_crq/'.$group_item_1->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?>
                <?php if($this->session->userdata('role_id')==2){?>
                <?php if ($group_item_1->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_ss_view/'.$group_item_1->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php if ($group_item_1->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_ss_view_erq_crq/'.$group_item_1->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?>
                ...
                <?php if ($group_item_1->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_ae_view_erq_crq/'.$group_item_1->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?></td></tr>
                <?php }?>
  ...
  <tr>
    ...
    <td><span class="urdufont-right" style="padding-left:20px"><?php echo html_entity_decode($group_item_1->item_option_d_ur);?></span></td>
			...
			?>
                ...
                <?php if($this->session->userdata('role_id')==3){?>
				<?php if ($group_item_2->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_view/'.$group_item_2->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php if ($group_item_2->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_view_erq_crq/'.$group_item_2->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?>
                <?php if($this->session->userdata('role_id')==2){?>
                <?php if ($group_item_2->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_ss_view/'.$group_item_2->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php if ($group_item_2->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_ss_view_erq_crq/'.$group_item_2->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?>
                <?php if($this->session->userdata('role_id')==4){?>
                ...
                <?php if ($group_item_2->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_ae_view_erq_crq/'.$group_item_2->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?></td></tr>
                <?php }?>
...
?>
			...
			?>
                ...
                <?php if($this->session->userdata('role_id')==3){?>
				<?php if ($group_item_3->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_view/'.$group_item_3->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php if ($group_item_3->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_view_erq_crq/'.$group_item_3->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?>
                <?php if($this->session->userdata('role_id')==2){?>
                <?php if ($group_item_3->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_ss_view/'.$group_item_3->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php if ($group_item_3->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_ss_view_erq_crq/'.$group_item_3->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?>
                <?php if($this->session->userdata('role_id')==4){?>
                ...
                <?php if ($group_item_3->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_ae_view_erq_crq/'.$group_item_3->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?></td></tr>
                <?php }?>
...
<?php } ?>
			...
			?>
                ...
                <?php if($this->session->userdata('role_id')==3){?>
				<?php if ($group_item_4->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_view/'.$group_item_4->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php if ($group_item_4->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_view_erq_crq/'.$group_item_4->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?>
                <?php if($this->session->userdata('role_id')==2){?>
                <?php if ($group_item_4->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_ss_view/'.$group_item_4->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php if ($group_item_4->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_ss_view_erq_crq/'.$group_item_4->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?>
                <?php if($this->session->userdata('role_id')==4){?>
                ...
                <?php if ($group_item_4->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_ae_view_erq_crq/'.$group_item_4->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?></td></tr>
                <?php }?>
...
<?php } ?>
			...
			?>
                ...
                <?php if($this->session->userdata('role_id')==3){?>
				<?php if ($group_item_5->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_view/'.$group_item_5->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php if ($group_item_5->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_view_erq_crq/'.$group_item_5->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?>
                <?php if($this->session->userdata('role_id')==2){?>
                <?php if ($group_item_5->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_ss_view/'.$group_item_5->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php if ($group_item_5->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_ss_view_erq_crq/'.$group_item_5->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?>
                <?php if($this->session->userdata('role_id')==4){?>
                ...
                <?php if ($group_item_5->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_ae_view_erq_crq/'.$group_item_5->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?></td></tr>
                <?php }?>
...
<?php } ?>
			...
			?>
                ...
                <?php if($this->session->userdata('role_id')==3){?>
				<?php if ($group_item_6->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_view/'.$group_item_6->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php if ($group_item_6->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_view_erq_crq/'.$group_item_6->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?>
                <?php if($this->session->userdata('role_id')==2){?>
                <?php if ($group_item_6->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_ss_view/'.$group_item_6->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php if ($group_item_6->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_ss_view_erq_crq/'.$group_item_6->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?>
                <?php if($this->session->userdata('role_id')==4){?>
                ...
                <?php if ($group_item_6->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_ae_view_erq_crq/'.$group_item_6->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?></td></tr>
                <?php }?>
...
<?php } ?>
			...
			?>
                ...
                <?php if($this->session->userdata('role_id')==3){?>
				<?php if ($group_item_7->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_view/'.$group_item_7->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php if ($group_item_7->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_view_erq_crq/'.$group_item_7->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?>
                <?php if($this->session->userdata('role_id')==2){?>
                <?php if ($group_item_7->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_ss_view/'.$group_item_7->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php if ($group_item_7->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_ss_view_erq_crq/'.$group_item_7->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?>
                <?php if($this->session->userdata('role_id')==4){?>
                ...
                <?php if ($group_item_7->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_ae_view_erq_crq/'.$group_item_7->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?></td></tr>
                <?php }?>
...
<?php } ?>
			...
			?>
                ...
                <?php if($this->session->userdata('role_id')==3){?>
				<?php if ($group_item_8->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_view/'.$group_item_8->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php if ($group_item_8->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_view_erq_crq/'.$group_item_8->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?>
                <?php if($this->session->userdata('role_id')==2){?>
                <?php if ($group_item_8->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_ss_view/'.$group_item_8->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php if ($group_item_8->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_ss_view_erq_crq/'.$group_item_8->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?>
                <?php if($this->session->userdata('role_id')==4){?>
                ...
                <?php if ($group_item_8->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_ae_view_erq_crq/'.$group_item_8->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?></td></tr>
                <?php }?>
...
<?php } ?>
			...
			?>
                ...
                <?php if($this->session->userdata('role_id')==3){?>
				<?php if ($group_item_9->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_view/'.$group_item_9->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php if ($group_item_9->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_view_erq_crq/'.$group_item_9->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?>
                <?php if($this->session->userdata('role_id')==2){?>
                <?php if ($group_item_9->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_ss_view/'.$group_item_9->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php if ($group_item_9->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_ss_view_erq_crq/'.$group_item_9->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?>
                <?php if($this->session->userdata('role_id')==4){?>
                ...
                <?php if ($group_item_9->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_ae_view_erq_crq/'.$group_item_9->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?></td></tr>
                <?php }?>
...
<?php } ?>
			...
			?>
                ...
                <?php if($this->session->userdata('role_id')==3){?>
				<?php if ($group_item_10->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_view/'.$group_item_10->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php if ($group_item_10->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_view_erq_crq/'.$group_item_10->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?>
                <?php if($this->session->userdata('role_id')==2){?>
                <?php if ($group_item_10->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_ss_view/'.$group_item_10->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php if ($group_item_10->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_ss_view_erq_crq/'.$group_item_10->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?>
                <?php if($this->session->userdata('role_id')==4){?>
                ...
                <?php if ($group_item_10->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_ae_view_erq_crq/'.$group_item_10->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?></td></tr>
                <?php }?>
...
<?php } ?>
      ...
      <div class="row" style="padding-top:20px">
        <div class="col-lg-12">
        	<table width="100%" border="1" style="text-align:center; margin-left:05px">
              ...
              <tr>
                <td><?php if(!empty($ss))
					{echo ($ss[0]['username']!="")?$ss[0]['username']:"";}?>(SS)</td>
              ...
              <tr>
                <td><?php if(!empty($ae)) {echo ($ae[0]['username']!="")?$ae[0]['username']:"";}?>(AE)</td>
              ...
              <tr>
                <td><?php echo $irinfo[0]['username'];?>(REVIEWER)</td>
     ...
     <?php echo form_open(base_url('admin/itemsgroup/rev_ss_submit_for_approval/'.$groupinfo->group_id), 'class="form-horizontal" enctype="multipart/form-data" ');  ?>  
    	<div style="padding-top:15px; margin-left:5px">
        	<?php 
			switch($total_items)
			{
				case 2:
				if($status_gi_1 == 2 && $status_gi_2 == 2)
				{
					?>
                    <label for="group_rev_ss_comment" class="col-sm-6 control-label">Reviewer Comments</label>
                    <textarea id="group_rev_ss_comment" name="group_rev_ss_comment" rows="4" cols="55" style="width:100%" ></textarea>
				...
				case 3:
				if($status_gi_1 == 2 && $status_gi_2 == 2 && $status_gi_3 == 2)
				{
					?>
                    <label for="group_rev_ss_comment" class="col-sm-6 control-label">Reviewer Comments</label>
                    <textarea id="group_rev_ss_comment" name="group_rev_ss_comment" rows="4" cols="55" style="width:100%" ></textarea>
				...
				case 4:
				if($status_gi_1 == 2 && $status_gi_2 == 2 && $status_gi_3 == 2 && $status_gi_4 == 2)
				{
					?>
                    <label for="group_rev_ss_comment" class="col-sm-6 control-label">Reviewer Comments</label>
                    <textarea id="group_rev_ss_comment" name="group_rev_ss_comment" rows="4" cols="55" style="width:100%" ></textarea>
				...
				case 5:
				if($status_gi_1 == 2 && $status_gi_2 == 2 && $status_gi_3 == 2 && $status_gi_4 == 2 && $status_gi_5 == 2)
				{
					?>
                    <label for="group_rev_ss_comment" class="col-sm-6 control-label">Reviewer Comments</label>
                    <textarea id="group_rev_ss_comment" name="group_rev_ss_comment" rows="4" cols="55" style="width:100%" ></textarea>
				...
				case 6:
				if($status_gi_1 == 2 && $status_gi_2 == 2 && $status_gi_3 == 2 && $status_gi_4 == 2 && $status_gi_5 == 2 && $status_gi_6 == 2)
				{
					?>
                    <label for="group_rev_ss_comment" class="col-sm-6 control-label">Reviewer Comments</label>
                    <textarea id="group_rev_ss_comment" name="group_rev_ss_comment" rows="4" cols="55" style="width:100%" ></textarea>
				...
				case 7:
				if($status_gi_1 == 2 && $status_gi_2 == 2 && $status_gi_3 == 2 && $status_gi_4 == 2 && $status_gi_5 == 2 && $status_gi_6 == 2 && $status_gi_7 == 2)
				{
					?>
                    <label for="group_rev_ss_comment" class="col-sm-6 control-label">Reviewer Comments</label>
                    <textarea id="group_rev_ss_comment" name="group_rev_ss_comment" rows="4" cols="55" style="width:100%" ></textarea>
				...
				case 8:
				if($status_gi_1 == 2 && $status_gi_2 == 2 && $status_gi_3 == 2 && $status_gi_4 == 2 && $status_gi_5 == 2 && $status_gi_6 == 2 && $status_gi_7 == 2 && $status_gi_8 == 2)
				{
					?>
                     <label for="group_rev_ss_comment" class="col-sm-6 control-label">Reviewer Comments</label>
                    <textarea id="group_rev_ss_comment" name="group_rev_ss_comment" rows="4" cols="55" style="width:100%" ></textarea>
				...
				case 9:
				if($status_gi_1 == 2 && $status_gi_2 == 2 && $status_gi_3 == 2 && $status_gi_4 == 2 && $status_gi_5 == 2 && $status_gi_6 == 2 && $status_gi_7 == 2 && $status_gi_8 == 2 && $status_gi_9 == 2)
				{
					?>
                    <label for="group_rev_ss_comment" class="col-sm-6 control-label">Reviewer Comments</label>
                    <textarea id="group_rev_ss_comment" name="group_rev_ss_comment" rows="4" cols="55" style="width:100%" ></textarea>
				...
				case 10:
				if($status_gi_1 == 2 && $status_gi_2 == 2 && $status_gi_3 == 2 && $status_gi_4 == 2 && $status_gi_5 == 2 && $status_gi_6 == 2 && $status_gi_7 == 2 && $status_gi_8 == 2 && $status_gi_9 == 2 && $status_gi_10 == 2)
				{
					?>
                    <label for="group_rev_ss_comment" class="col-sm-6 control-label">Reviewer Comments</label>
                    <textarea id="group_rev_ss_comment" name="group_rev_ss_comment" rows="4" cols="55" style="width:100%" ></textarea>
			 ...
			 ?>
            <a href=<?php echo base_url('admin/itemsgroup/rev_ss_edit/'.$groupinfo->group_id); ?>><input type="button" name="edit" id="edit" value="Edit" class="btn btn-info pull-right" style="margin:5px; width:80px"></a>
        </div>
     <?php echo form_close( );?>
        </div>
      </div>

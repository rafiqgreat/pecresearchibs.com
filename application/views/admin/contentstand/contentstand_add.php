      ...
      <div class="card card-default color-palette-bo">
        <div class="card-header">
          <div class="d-inline-block">
              ...
              Add New Content Stand</h3>
          </div>
          <div class="d-inline-block float-right">
            <a href="<?= base_url('admin/contentstand'); ?>" class="btn btn-success"><i class="fa fa-list"></i>  Content Stand List</a>
          </div>
        </div>
        <div class="card-body">   
           <!-- For Messages -->
            ...
            <?php echo form_open(base_url('admin/contentstand/add'), 'class="form-horizontal"');  ?> 
              ...
              <div class="row">
                <div class="col-lg-6 col-sm-12">
                    <label for="cs_number" class=" control-label">Content Stand Number</label>
              ...
              <div class="row">
                <div class="col-lg-6 col-sm-12">
                    <label for="cs_statement_en" class="control-label">Content Stand (Eng)</label>
              ...
              <div class="form-group">
                <div class="col-md-12">
                  <input type="submit" name="submit" value="Add Content Stand" class="btn btn-info pull-right">
                </div>
              </div>
            <?php echo form_close( ); ?>
          <!-- /.box-body -->

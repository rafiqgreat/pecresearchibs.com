...
?>
                ...
                <tr>
                  <td colspan="2" style="text-align:right; font-weight:bold" class="urdufont-right"> سوال نمبر  22 : &nbsp; <?php echo html_entity_decode($item22->item_stem_ur);?></td>
                </tr>
                <?php }?>
...
?>
                ...
                <tr>
                  <td colspan="2" style="text-align:right; font-weight:bold" class="urdufont-right"> سوال نمبر  23 : &nbsp; <?php echo html_entity_decode($item23->item_stem_ur);?></td>
                </tr>
                <?php }?>
...
?>
                ...
                <tr>
                  <td colspan="2" style="text-align:right; font-weight:bold" class="urdufont-right"> سوال نمبر  24 : &nbsp; <?php echo html_entity_decode($item24->item_stem_ur);?></td>
                </tr>
                <?php }?>
...
?>
                ...
                <tr>
                  <td colspan="2" style="text-align:right; font-weight:bold" class="urdufont-right"> سوال نمبر  25 : &nbsp; <?php echo html_entity_decode($item25->item_stem_ur);?></td>
                </tr>
                <?php }?>
